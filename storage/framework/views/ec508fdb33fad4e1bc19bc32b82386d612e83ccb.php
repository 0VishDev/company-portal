    ...
    <div class="container register">
                <div class="row">
                    ...
                    <div class="top-heading">
                        <h1>VR Distributorship Profile Sheet</h1>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <form action="<?php echo e(url('distributorship/profile/add')); ?>" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="register-right mb-3">
                             <div class="row register-form">
                                    <div class="col-md-12 text-center mb-2">
                                    <h2>VR Distributorship Criteria</h2>
                                    </div>
                                        <div class="col-sm-6 form-group mb-3">
...
</html><?php /**PATH /home/ltqh13w2vszk/public_html/text/resources/views/mettersheets/distributorship.blade.php ENDPATH**/ ?>