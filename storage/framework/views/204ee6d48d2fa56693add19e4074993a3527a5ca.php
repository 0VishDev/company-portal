  ...
  <main role="main" class="main-content">
      ...
      <div id="search-form" class="position-absolute">
          ...
          <form id="search-header" method="GET" action="<?php echo e(route('shop')); ?>"  class="search-form-result">
            <div class=" text-center">
              <h3 class="text-black">Search for products & find sellers near you</h3>
            </div>
            <div class="search-form position-relative">
              <select class="" name="city" id="home_city" placeholder="Search city name">
                  <option value="All">All India</option>
              </select>
              <input type="text" name="search" class="search-input" placeholder="Enter product name or seller name..." autocomplete="off" required>
        ...
        <div class="carousel-item <?php if($k == 1): ?> active <?php endif; ?>">
          ...
          <div class="container">
            <div class="carousel-caption <?php if($slide->slide_text_position != ''): ?> text-<?php echo e($slide->slide_text_position); ?> <?php else: ?> text-left <?php endif; ?>">
              ...
              <p><?php if($slide->slide_btn_link != ''): ?><a class="btn button-color" href="<?php echo e($slide->slide_btn_link); ?>" role="button" target="_blank"><?php endif; ?> <?php if($slide->slide_btn_text != ''): ?> <?php echo e($slide->slide_btn_text); ?>
    ...
    <div class="container white-box">
      ...
      <div class="row">
        ...
        <?php $catCount += 1; if($catCount > 10) { break; } ?>
        
        <div class="icon-category pt-2 pb-2 ash-border col-lg-2 col-md-2 col-sm-4  ml-3 mr-3" align="center">
          <a href="<?php echo e(URL::to('/shop?cat_id='.$category->cat_id)); ?>" title="<?php echo e($category->category_name); ?>">
          ...
          <p><a href="<?php echo e(URL::to('/shop?cat_id='.$category->cat_id)); ?>" class="link-color fs14"><?php echo e($category->category_name); ?></a></p>
        </div>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    ...
    <div class="container pt-3 mt-3 pb-3 mb-3">
      <div class="row">
        <h4 class="black mb-2 pb-2">Trending Categories</h4>
      ...
      <div class="row">
        ...
        <div class="col-md-12">
          <div class="ind-hub">
            ...
            <a href="<?php echo e(url('/')); ?>/regions/<?php echo e($state->id); ?>" class="ind-hub-items d-flex flex-wrap justify-content-center">
              <div class="ind-hub-img wd100 center">
                <img src="/public/<?php echo e($state->state_image); ?>" />
              </div>
            ...
            <a href="<?php echo e(url('/')); ?>/locations" class="ind-hub-items d-flex flex-wrap justify-content-center">
              <div class="ind-hub-img wd100 center">
                <img src="https://tiimg.tistatic.com/new_website1/ti-design/images/industry-hubs/more.png" />
              </div>
...
<?php endif; ?><?php /**PATH /home/ltqh13w2vszk/public_html/venicered.com/resources/views/index.blade.php ENDPATH**/ ?>