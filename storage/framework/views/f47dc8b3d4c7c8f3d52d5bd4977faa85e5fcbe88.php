                                ...
                                <table class="table table-striped table-bordered table-responsive" id="productInquiryTable">
                                    ...
                                    <?php $__currentLoopData = $productInquiry; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $inquiry): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <a href="#" class="btn btn-danger mb-1" title="Edit" data-inquiry-edit inquiry="<?php echo e($inquiry); ?>"><span class="fa fa-pencil"></span></a>
                                            
                                            <?php if($inquiry->is_verify == 0): ?>
                                                <a href="<?php echo e(url('admin/inquiries/'.$inquiry->inquiry_id.'/verify')); ?>" class="btn btn-danger mb-1" title="Verify"><span class="fa fa-stop-circle-o"></span></a>
                                            <?php endif; ?>
                                            <a href="<?php echo e(url('admin/inquiries/'.$inquiry->inquiry_id.'/delete')); ?>" class="btn btn-danger mb-1" title="Delete" onClick="return confirm('Are you sure you want to delete?');"><span class="fa fa-trash"></span></a>
                                            <?php if($inquiry->is_send_to_seller == 0): ?>
                                                <a href="<?php echo e(url('admin/inquiries/'.$inquiry->inquiry_id.'/send')); ?>" class="btn btn-danger mb-1" title="Send Seller Lead"><span class="fa fa-send-o" style="font-size: 13px;"></span></a>
                                            <?php endif; ?>
                                            </td>
                                        </tr>
...
</html><?php /**PATH /home/ltqh13w2vszk/public_html/text/resources/views/admin/inquiries.blade.php ENDPATH**/ ?>