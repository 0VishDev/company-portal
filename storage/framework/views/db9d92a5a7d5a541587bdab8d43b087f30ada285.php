<?php echo $__env->make('vendor-dash.left-panel', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
         ...
         <!--              </div>-->
                       ...
                       <?php $__currentLoopData = $attribute['display']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $attribute): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    	                ...
    	                <div class="col-sm-6">
                            ...
                            <div class="">
                                ...
                                <input type="text" class="form-control" id="product_name" name="product_name" value="<?php echo e(($mode == 'edit' ? $product->product_name : '')); ?>" product-input-search required>
                       ...
                       <div class="form-group col-sm-12">
                          <div class="">
                            ...
                            <input type="text" class="form-control" name="price" id="price" value="<?php echo e(($mode == 'edit' ? $product->product_price : '')); ?>" >
                       ...
                       <div class="form-group col-sm-12">
                           <div class="">
                                ...
                                <input type="text" name="minimum_order_qty" id="minimum_order_qty" class="form-control"  value="<?php echo e(($mode == 'edit' ? $product->minimum_order_qty : '')); ?>" >
                        ...
                        <div class="form-group col-sm-12">
                             ...
                             <input type="text" name="minimum_order_unit" id="minimum_order_unit" class="form-control" value="<?php echo e(($mode == 'edit' ? $product->minimum_order_unit : '')); ?>" >
	...
	<?php echo $__env->make('vendor-dash.bottom-links', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/a0yq2z3dupoj/public_html/resources/views/vendor-dash/add-product.blade.php ENDPATH**/ ?>