    ...
    <div class="col-6 col-lg-4">
        <div class="card">
            <div class="card-body">
                ...
                <hr>
                <div class="more-info pt-2" style="margin-bottom:-10px;">
                    <a class="font-weight-bold font-xs btn-block text-muted small" href="<?php echo e(url('/admin/sub-administrator')); ?>">View More <i class="fa fa-angle-right float-right font-lg"></i></a>
                </div>
            </div>
        </div>
    </div>
...
</html><?php /**PATH /home/a0yq2z3dupoj/public_html/businessworldtrade.in/resources/views/admin/index.blade.php ENDPATH**/ ?>