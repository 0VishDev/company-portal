		...
		<div class="row">
			...
			<?php if(count($shop['product']) > 9): ?>
				<div class="col-sm-12 col-md-12 text-center">
				    ...
				    <button type="button" class="btn btn-sm btn-success" id="product_show_more_btn">Show More</button>
				    <button type="button" class="btn btn-sm btn-success" id="product_show_less_btn" style="display: none;">Show Less</button>
				</div>
			<?php endif; ?>
		</div>
	</div>
...
<?php echo $__env->make('vendor-themes.theme-4.includes.footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ltqh13w2vszk/public_html/text/resources/views/vendor-themes/theme-4/index.blade.php ENDPATH**/ ?>