<footer class="section-footer pt-3 mt-3" id="footer">
	<div class="container pt-3">
		<section class="footer-top padding-top">
			<div class="row">
			    <aside class="col-sm-1 col-md-1 col-lg-1 white"></aside>
				...
				<aside class="col-sm-4 col-md-2 col-lg-2 white">
					...
					<ul class="list-unstyled">
                        ...
                        <li> <a href="<?php echo e(URL::to('/vrtrust')); ?>" target="_blank"> VR Trust Certificate</a></li>
					</ul>
				</aside>
...
<?php /**PATH /home/ltqh13w2vszk/public_html/resources/views/footer.blade.php ENDPATH**/ ?>