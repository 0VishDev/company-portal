      ...
      <div class="col-lg-5 col-md-5 col-sm-4 mt-2 pt-1 mb-1">
        <nav class="pull-right" id="nav-menu-container">
          <ul class="nav-menu">
            ...
            <li> <a href="<?php echo e(URL::to('/distributorships')); ?>"> Distributorships </a></li>
            ...
            <li class="menu-has-children"><a href="javascript:void(0)"><?php echo e(Helper::translation(2042,$translate)); ?></a>
              <ul>
                ...
                <li><a href="<?php echo e(url('/my-orders')); ?>"><?php echo e(Helper::translation(2026,$translate)); ?></a>
      ...
      <div class="col-lg-2 col-md-12 col-sm-12">
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="nav navbar-nav ml-auto">
            ...
            <li class="nav-item">
              <a class="nav-link" href="<?php echo e(url('/wishlist')); ?>"><i class="fa fa-heart-o" aria-hidden="true"></i> <?php echo e(Helper::translation(2053,$translate)); ?></a>
            </li>
...
</header><?php /**PATH /home/inforrmz/zigkart.inforidgetechnologyindia.com/resources/views/header.blade.php ENDPATH**/ ?>