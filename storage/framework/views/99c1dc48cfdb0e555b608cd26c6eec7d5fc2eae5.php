                ...
                <?php $__currentLoopData = $shopProducts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php
                        ...
                        if(isset($shop['isUser']) && $shop['isUser'] == 1){
                            if(!in_array($product->user_id, $productUserIds)){
                                array_push($productUserIds, $product->user_id);
                            }else{
                              continue;
                            }
                        }
                ...
                <div class="col-sm-12 col-md-12">
            		...
            		<div class="row">
                			   ...
                			   <div class="pack-bg">
                			       <div class="imageInn">
                			           <?php if(!empty($serviceProvider->provider_small_image)): ?> 
                                          <img src="<?php echo e(url('/')); ?>/public/storage/service-providers/<?php echo e($serviceProvider->provider_small_image); ?>" class="pack-tag" alt="<?php echo e($serviceProvider->provider_small_image); ?>" />
                                       <?php else: ?> 
                                          <img src="<?php echo e(url('/')); ?>/public/img/bronze-icon.png" class="pack-tag" alt="<?php echo e($serviceProvider->provider_small_image); ?>" />  
                                       <?php endif; ?>
                            		</div>
                            		<div class="hoverImg">
                            		    <?php if(!empty($serviceProvider->provider_image)): ?> 
                                          <img src="<?php echo e(url('/')); ?>/public/storage/service-providers/<?php echo e($serviceProvider->provider_image); ?>" class="pack-tag1" alt="<?php echo e($serviceProvider->provider_name); ?>" />
                                       <?php else: ?> 
                                          <img src="<?php echo e(url('/')); ?>/public/img/BRONZE.png" class="pack-tag1" alt="<?php echo e($serviceProvider->provider_name); ?>" />  
                                       <?php endif; ?>
                                    </div>
                		        </div>
                		    <?php endif; ?>
            			...
            			<div class="col-xs-7 col-sm-12 col-md-5 mb-1">
            				...
            				<hr>
            				<p class="pro-d"><span>Price Range : <?php echo e((is_numeric($product->product_price) ? '₹'.$product->product_price : $product->product_price)); ?></span></p>
            			...
            			<div class="seller-detail">
            				...
            				<p><a href="<?php echo e(url('user?user_id='.$product->user->id.'&user_type=vendor')); ?>"> <?php echo e((isset($product->user->company_name) ? $product->user->company_name : '')); ?></a> <small class="text-red"><b>(<?php echo e((isset($product->user->primary_type) ? $product->user->primary_type : '')); ?>)</b></small></p>
            				...
            				<p class="saller-contact">
            					<span class="phone"><a href="tel:<?php echo e((!empty($product->user->mobile) ? $product->user->mobile : (!empty($product->user->mobile) ? $product->user->mobile : ''))); ?>"><i class="fa fa-phone" aria-hidden="true"></i> <?php echo e((!empty($product->user->mobile) ? $product->user->mobile : (!empty($product->user->mobile) ? $product->user->mobile : ''))); ?></a></span>
...
<?php endif; ?><?php /**PATH /home/ltqh13w2vszk/public_html/text/resources/views/shop.blade.php ENDPATH**/ ?>