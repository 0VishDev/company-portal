    					...
    					<li>
                            ...
                            <div class="product-item bg-light">
                            	<div class="card text-center">
                            		...
                            		<div class="card-body">
                            		    <h4 class="card-title"><a href="<?php echo e(URL::to('/product')); ?>/<?php echo e($product->product_slug); ?>" title="<?php echo e($product->product_name); ?>"><?php echo e($product->product_name); ?></a></h4>
                            		    <p class="card-text"><button class="btn btn-theme2 btn-sm" title="<?php echo e($product->product_name); ?>" data-send-inquiry-btn seller="<?php echo e($product->user); ?>" buyer="<?php if(Auth::check()): ?> <?php echo e(Auth::user()); ?> <?php endif; ?>" product="<?php echo e($product); ?>">Send Inquiry</button></p>
                            		</div>
                            	</div>
                            </div>
    					</li>
		...
		<div class="row">
			...
			<div class="col-lg-12 col-md-12 mb-3">
				<div class="row">
					...
					<div class="col-lg-4 col-md-6 mb-3" style="<?php echo e(($key > 8 ? 'display:none;' : '')); ?>" <?php echo e(($key > 8 ? 'data-product-list' : '')); ?>>
						<!-- ad listing list  -->
						<div class="ad-listing-list mt-20 shadow">
									...
									<div class="row">
										<div class="col-lg-12 col-md-12 mb-3">
											<div class="ad-listing-content">
												<div>
													<h4><a href="<?php echo e(URL::to('/product')); ?>/<?php echo e($product->product_slug); ?>" title="<?php echo e($product->product_name); ?>" class="font-weight-bold"><?php echo e($product->product_name); ?></a></h4>
												</div>
			...
			<?php if(count($shop['product']) > 9): ?>
				<div class="col-sm-12 col-md-12 text-center">
				    ...
				    <button type="button" class="btn btn-sm btn-theme2" id="product_show_more_btn">Show More</button>
				    <button type="button" class="btn btn-sm btn-theme2" id="product_show_less_btn" style="display: none;">Show Less</button>
				</div>
			<?php endif; ?>
		</div>
	</div>
...
<?php echo $__env->make('vendor-themes.theme-2.includes.footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/a0yq2z3dupoj/public_html/businessworldtrade.in/resources/views/vendor-themes/theme-2/index.blade.php ENDPATH**/ ?>