...
<head>
  <?php if(!empty($pageSEO)): ?>
      ...
      <?php else: ?>
        <title><?php echo e(($category['category_name'])); ?> - <?php echo e($allsettings->site_title); ?></title>
      <?php endif; ?>
  ...
  <main role="main" class="main-content">
	...
	<section class="headerbg" style="background-image: url('<?php echo e(url('/')); ?>/public/storage/settings/<?php echo e($allsettings->site_header_background); ?>');">
      <div class="container text-left">
        ...
        <p class="mb-0"><a href="/">Home</a> <span class="split">&gt;</span> <span><?php echo e(($category['category_name'])); ?></span></p>
      </div>
    </section>
...
<?php endif; ?><?php /**PATH /home/a0yq2z3dupoj/public_html/demo/resources/views/sub-categories.blade.php ENDPATH**/ ?>