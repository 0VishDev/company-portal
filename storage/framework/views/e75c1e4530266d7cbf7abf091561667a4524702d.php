  ...
  <main role="main" class="main-content">
    ...
    <section class="headerbg" style="background-image: url('/public/storage/settings/1595596012191.jpg');">
      <div class="container text-left">
        ...
        <p class="mb-0"><a href="/">Home</a> <span class="split">&gt;</span> <span>All Categories</span></p>
      </div>
    </section>
          ...
          <div class="row">
            <div class="col-sm-12 col-md-4 col-lg-3">
              ...
              <div class="sm-margin-five-bottom last-paragraph-no-margin text-center">
                <a href="/shop?cat_id=<?php echo e($category->cat_id); ?>">
                  <div class="feature-box" style="background:#ff1d25; height: 350px; box-shadow: inset 0 0 50px #963a3a!important;">
                    <div class="direc">
                      <img src="<?php echo e(url('/')); ?>/public/storage/category/<?php echo e($category->category_image); ?>">
                      <p><?php echo e($category->category_name); ?></p>
                      <a href="/shop?cat_id=<?php echo e($category->cat_id); ?>" style="color: white;">View All</a>
                    </div>
                  </div>
                </a>
              </div>
              ...
              <div class="row">
                ...
                <div class="col-12 col-md-6 col-lg-4 sm-margin-five-bottom mb-3">
                  <div class="feature-box">
                    <a href="/shop?subcat_id=<?php echo e($subcategory['subcat_id']); ?>">
                      <div class="content medi-box">
                        <div class="madi-text">
                          <div class="text-medium"><?php echo e($subcategory['subcategory_name']); ?></div>
                        </div>
                        <img src="<?php echo e(url('/')); ?>/public/storage/subcategory/<?php echo e($subcategory['subcategory_image']); ?>">
                      </div>
                    </a>
                  </div>
                </div>
                ...
                <div class="col-12 col-md-6 col-lg-4 sm-margin-five-bottom mb-3">
                  <div class="feature-box">
                    <a href="<?php echo e(url('sub-category/'.$category->cat_id)); ?>">
                      <div class="content medi-box all">
                        <img src="<?php echo e(url('/')); ?>/public/storage/product/arrow.png">
                      </div>
                    </a>
                  </div>
                </div>
...
<?php endif; ?><?php /**PATH /home/inforrmz/venicered.com/resources/views/all-categories.blade.php ENDPATH**/ ?>