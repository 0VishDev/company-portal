  ...
  <main role="main">
    <div class="container">
            ...
            <div class="clearfix">
              <ul id="image-gallery" class="gallery list-unstyled cS-hidden">
                ...
                <li data-thumb="<?php echo e(url('/')); ?>/public/storage/product/<?php echo e($shop->product_image); ?>">
                  <a href="">
                    <img src="<?php echo e(url('/')); ?>/public/storage/product/<?php echo e($shop->product_image); ?>" alt="<?php echo e($shop->product_name); ?>" />
                  </a>
                </li>
                <?php endif; ?>
                ...
                <li data-thumb="<?php echo e(url('/')); ?>/public/storage/product/<?php echo e($images->product_image); ?>">
                  <a href="">
                    <img src="<?php echo e(url('/')); ?>/public/storage/product/<?php echo e($images->product_image); ?>"  alt="<?php echo e($shop->product_name); ?>"/>
                  </a>
                </li>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                <?php endif; ?>
      ...
      <div class="mt-2"><?php echo e(Helper::translation(1987,$translate)); ?> : <span><a
            href="<?php echo e(URL::to('/user?user_id='.$seller->id.'&user_type='.$seller->user_type)); ?>" class="theme-color"><?php echo e($seller->name); ?></a></span>
      </div>
      <?php if(!is_null($shop->minimum_order_qty)): ?>
      <div class="mt-2">
        <span class="text-danger">Minimum Order: <?php echo e($shop->minimum_order_qty); ?>

        </span> <br>
        <span class="text-danger">Maximum Order: <?php echo e($shop->minimum_order_unit); ?>
...
<?php endif; ?><?php /**PATH /home/ltqh13w2vszk/public_html/text/resources/views/product.blade.php ENDPATH**/ ?>