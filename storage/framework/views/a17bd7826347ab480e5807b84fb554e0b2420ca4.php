                            ...
                            <div class="card-body">
                                <table class="table table-striped table-bordered" id="visitorsTable">
                                    ...
                                    <?php $__currentLoopData = $visitors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $visitor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            <td><?php echo e(++$no); ?></td>
                                            <td><?php echo e($visitor->user->name); ?></td>
                                            <td><?php echo e($visitor->user->company_name); ?></td>
                                            <td><?php echo e($visitor->user->email); ?></td>
                                            <td><?php echo e($visitor->user->mobile); ?></td>
                                            <td><?php echo e($visitor->total_visit_count); ?></td>
                                        </tr>
...
</html><?php /**PATH /home/ltqh13w2vszk/public_html/resources/views/admin/visitors.blade.php ENDPATH**/ ?>