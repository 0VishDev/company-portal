...
<section class="bg-gray pt-5" id="contact">
    <div class="container">
        <div class="row">
			...
			<div class="col-md-6 col-sm-12">
			    <fieldset class="p-4">
			    <img src="<?php echo e(url('/')); ?>/public/img/theme-contact.jpg" class="img img-responsive" width="100%" alt="contact img">
			                            </fieldset>
			</div>
        </div>
    </div>
      ...
      <div class="col-lg-4 col-md-3 mb-3">
        <div class="block">
          ...
          <ul>
            ...
            <a href="sms:/<?php echo e($user_details->mobile); ?>"><button type="button" class="btn btn-sm btn-theme4"><i class="fa fa-commenting-o" aria-hidden="true"></i> Send SMS</button></a>
            <a href="mailto:<?php echo e($user_details->email); ?>" class=" ml-3"><button type="button" class="btn btn-sm btn-theme4"><i class="fa fa-envelope" aria-hidden="true"></i> Send Email</button></a>
          </div>
        </div>
      </div>
...
<!-- JAVASCRIPTS -->
<script src="<?php echo e(asset('resources/views/template/vendor-themes/theme-4/plugins/jQuery/jquery.min.js')); ?>"></script>
<script src="<?php echo e(asset('resources/views/template/vendor-themes/theme-4/plugins/bootstrap/js/popper.min.js')); ?>"></script>
<script src="<?php echo e(asset('resources/views/template/vendor-themes/theme-4/plugins/bootstrap/js/bootstrap.min.js')); ?>"></script>
<script src="<?php echo e(asset('resources/views/template/vendor-themes/theme-4/plugins/bootstrap/js/bootstrap-slider.js')); ?>"></script>
  <!-- tether js -->
<script src="<?php echo e(asset('resources/views/template/vendor-themes/theme-4/plugins/tether/js/tether.min.js')); ?>"></script>
<script src="<?php echo e(asset('resources/views/template/vendor-themes/theme-4/plugins/raty/jquery.raty-fa.js')); ?>"></script>
<script src="<?php echo e(asset('resources/views/template/vendor-themes/theme-4/plugins/slick-carousel/slick/slick.min.js')); ?>"></script>
<script src="<?php echo e(asset('resources/views/template/vendor-themes/theme-4/plugins/jquery-nice-select/js/jquery.nice-select.min.js')); ?>"></script>
<script src="<?php echo e(asset('resources/views/template/vendor-themes/theme-4/plugins/fancybox/jquery.fancybox.pack.js')); ?>"></script>
<script src="<?php echo e(asset('resources/views/template/vendor-themes/theme-4/plugins/smoothscroll/SmoothScroll.min.js')); ?>"></script>
<!-- google map -->
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCcABaamniA6OL5YvYSpB3pFMNrXwXnLwU&libraries=places"></script>
<script src="<?php echo e(asset('resources/views/template/vendor-themes/theme-4/plugins/google-map/gmap.js')); ?>"></script>
<script src="<?php echo e(asset('resources/views/template/vendor-themes/theme-4/js/script.js')); ?>"></script>
...
</html><?php /**PATH /home/a0yq2z3dupoj/public_html/resources/views/vendor-themes/theme-4/includes/footer.blade.php ENDPATH**/ ?>