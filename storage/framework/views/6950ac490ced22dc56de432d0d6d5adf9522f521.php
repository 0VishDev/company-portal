                ...
                <div class="row">
                  <div class="col-md-12">
                       <?php if($demo_mode == 'on'): ?>
                           ...
                           <?php else: ?>
                           <form action="<?php echo e(route('admin.add-attribute-type')); ?>" method="post" id="setting_form" enctype="multipart/form-data">
...
</html><?php /**PATH /home/inforrmz/b2bkart.inforidgetechnologyindia.com/resources/views/admin/add-attribute-type.blade.php ENDPATH**/ ?>