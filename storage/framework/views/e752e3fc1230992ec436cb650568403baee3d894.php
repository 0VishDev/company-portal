                                ...
                                <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                    ...
                                    <?php $__currentLoopData = $postData['post']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td><a href="comment/<?php echo e($post->post_id); ?>" class="blue-color">Comments [<?php echo e($comments->has($post->post_id) ? count($comments[$post->post_id]) : 0); ?>]</a></td>
                                            ...
                                            <?php else: ?>
                                            <a href="post/<?php echo e($post->post_id); ?>" class="btn btn-danger btn-sm" onClick="return confirm('Are you sure you want to delete?');"><i class="fa fa-trash"></i>&nbsp;Delete</a><?php endif; ?></td></tr><?php $no++; ?>
...
</html><?php /**PATH /home/inforrmz/b2bkart.inforidgetechnologyindia.com/resources/views/admin/post.blade.php ENDPATH**/ ?>