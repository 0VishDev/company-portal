           ...
           <div class="main-div loginform col-md-5 mx-auto">
               ...
               <form action="<?php echo e(route('login')); ?>" method="POST" id="login_form">
                ...
                <div class="form-group">
                    ...
                    <input id="password" type="password" class="form-control rounded-0" name="password" placeholder="<?php echo e(Helper::translation(2102,$translate)); ?>" data-bvalidator="required">
...
</html><?php /**PATH /home/inforrmz/venicered.com/resources/views/auth/login.blade.php ENDPATH**/ ?>