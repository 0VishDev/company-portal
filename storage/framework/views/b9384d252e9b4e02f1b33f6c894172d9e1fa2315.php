...
<body>
		...
		<nav class="navbar navbar-expand-sm navbar-default">
			...
			<div id="main-menu" class="main-menu collapse navbar-collapse">
				<ul class="nav navbar-nav">
					<li class="<?php echo e(( ( \Request::is('vendor/dashboard')) ? 'current' : '')); ?>"><a href="<?php echo e(url('/')); ?>/vendor/dashboard"> <i class="menu-icon fa fa-dashboard"></i>Dashboard </a></li>
				    
				    <li class="menu-item-has-children dropdown <?php echo e(( ( \Request::is('vendor/contact-profile') || \Request::is('vendor/business-profile') || \Request::is('vendor/statutory-profile') || \Request::is('vendor/bank-details')) ? 'current show' : '')); ?>">
						<a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true"
							aria-expanded="false"> <i class="menu-icon fa fa-gears"></i>Company Profile</a>
						<ul class="sub-menu children dropdown-menu <?php echo e(( ( \Request::is('vendor/contact-profile') || \Request::is('vendor/business-profile') || \Request::is('vendor/statutory-profile') || \Request::is('vendor/bank-details')) ? 'show' : '')); ?>">
				    ...
				    <li class="<?php echo e(( ( \Request::is('vendor/premium-services')) ? 'current' : '')); ?>">
						<a href="<?php echo e(url('/')); ?>/vendor/premium-services"> <i class="menu-icon fa fa-envelope"></i>Services Package</a>
					</li>
					...
					<li class="<?php echo e(( ( \Request::is('vendor/manage-products')) ? 'current' : '')); ?>"><a href="<?php echo e(url('/')); ?>/vendor/manage-products"> <i class="menu-icon fa fa-shopping-cart"></i>Manage Products </a></li>
					<li class="<?php echo e(( ( \Request::is('vendor/my-drive')) ? 'current' : '')); ?>"><a href="<?php echo e(url('/')); ?>/vendor/my-drive"> <i class="menu-icon fa fa-shopping-cart"></i> Products Docs</a></li>
	...
	</aside><?php /**PATH /home/inforrmz/venicered.com/resources/views/vendor-dash/left-panel.blade.php ENDPATH**/ ?>