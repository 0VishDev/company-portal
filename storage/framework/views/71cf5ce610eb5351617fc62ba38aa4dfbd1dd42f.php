              ...
              <div class="single-blog-content">
                ...
                <?php $__currentLoopData = $postSteps; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $postStep): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="row midcon <?php echo e((($no % 2)? '': 'direction')); ?>">
                        <div class="col-lg-7">
                            <p><span style="font-weight:bold"><?php echo e($no); ?> - <?php echo e($postStep->step_name); ?></span>-<?php echo $postStep->step_description; ?></p>
                        </div>
                        <div class="col-lg-4">
...
<?php endif; ?><?php /**PATH /home/a0yq2z3dupoj/public_html/resources/views/single.blade.php ENDPATH**/ ?>