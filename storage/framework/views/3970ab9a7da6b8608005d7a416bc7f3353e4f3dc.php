    ...
    <div class="row">
      ...
      <div class="col-sm-6 col-12">
        ...
        <ul class="social-media-icons float-right">
          <li>Managed and Developed by <a href="<?php echo e(url('/')); ?>">Business World Trade</a></li>
        </ul>
      </div>
    </div>
  </div>
...
</html><?php /**PATH /home/a0yq2z3dupoj/public_html/demo/resources/views/vendor-themes/theme-3/includes/footer.blade.php ENDPATH**/ ?>