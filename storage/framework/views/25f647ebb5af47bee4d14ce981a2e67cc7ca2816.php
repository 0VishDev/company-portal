                  ...
                  <div class="modal-body">
                      <form action="<?php echo e(url('admin/vendor/account-manager/add')); ?>" method="POST">
    					  ...
    					  <div class="form-group">
    						...
    						<div class="col-sm-12">          
    						  <input type="url" class="form-control mb-2" id="company_website" placeholder="https://www.businessworldtrade.com/" name="company_website" value="<?php echo e($user->company_website); ?>">
    						</div>
    					  </div>
...
</html><?php /**PATH /home/a0yq2z3dupoj/public_html/resources/views/admin/vendor.blade.php ENDPATH**/ ?>