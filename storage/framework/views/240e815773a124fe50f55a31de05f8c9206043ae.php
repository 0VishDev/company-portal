                                    ...
                                    <?php $__currentLoopData = $serviceProviders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $serviceProvider): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="<?php echo e(url('admin/dealing-services-delete/'.$serviceProvider->id.'/delete')); ?>" class="btn btn-danger mb-1" onClick="return confirm('Are you sure you want to delete?');"><i class="fa fa-trash"></i></a>
                                            </td>
      ...
      <div class="modal-dialog modal-sm modal-dialog-centered " role="document">
        <div class="modal-content">
          <div class="modal-header">
           ...
           <form action="<?php echo e(url('admin/services-dealing/comment/add')); ?>" method="POST" enctype="multipart/form-data">
               <?php echo csrf_field(); ?>
...
</html><?php /**PATH /home/a0yq2z3dupoj/public_html/resources/views/admin/service-providers/dealing.blade.php ENDPATH**/ ?>