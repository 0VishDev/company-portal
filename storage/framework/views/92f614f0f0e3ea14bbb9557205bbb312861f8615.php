<?php echo $__env->make('vendor-themes.theme-3.includes.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                            ...
                            <div class="product-item bg-light">
                            	<div class="card text-center">
                            		...
                            		<div class="card-body p-4">
                            		    ...
                            		    <p class="card-text"><button class="btn btn-theme3 btn-sm" title="<?php echo e($product->product_name); ?>" data-send-inquiry-btn seller="<?php echo e($product->user); ?>" buyer="<?php if(Auth::check()): ?> <?php echo e(Auth::user()); ?> <?php endif; ?>" product="<?php echo e($product); ?>">Send Inquiry</button></p>
                            		</div>
                            	</div>
                            </div>
    					</li>
...
<section class="">
	<div class="container">
            	     ...
            	     <?php $__currentLoopData = $user_details->package_tags; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $packageTag): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    	<div class="col-sm-12 col-md-6 col-lg-3 mb-3">
                    	    <div class="shadow vendor">
                    		    ...
                    		    <span>Services Package<br><span class="pack-abo"><?php echo e($packageTag->service_provider->provider_name); ?></span></span>
                    		</div>
                    	</div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                  <?php endif; ?>
					...
					<div class="col-sm-12 col-md-6 col-lg-3 mb-3">
						<div class="shadow vendor">
							...
							<span>Nature of Business<br><span class="pack-abo"><?php echo e($user_details->nature_of_business); ?></span></span>
						</div>
					</div>
					<div class="col-sm-12 col-md-6 col-lg-3 mb-3">
						<div class="shadow vendor">
							...
							<span>Total Number of Employees<br><span class="pack-abo"><?php echo e($user_details->no_of_employees); ?></span></span>
						</div>
					</div>
					<div class="col-sm-12 col-md-6 col-lg-3 mb-3">
						<div class="shadow vendor">
							...
							<span>Year of Establishment<br><span class="pack-abo"><?php echo e($user_details->year_of_establishment); ?></span></span>
						</div>
					</div>
					<div class="col-sm-12 col-md-6 col-lg-3 mb-3">
						<div class="shadow vendor">
							...
							<span>Legal Status of Firm<br><span class="pack-abo"><?php echo e($user_details->legal_status_of_firm); ?></span></span>
						</div>
					</div>
					<div class="col-sm-12 col-md-6 col-lg-3 mb-3">
						<div class="shadow vendor">
							...
							<span>Annual Turnover<br><span class="pack-abo"><?php echo e($user_details->annual_turnover); ?></span></span>
						</div>
					</div>
					<div class="col-sm-12 col-md-6 col-lg-3 mb-3">
						<div class="shadow vendor">
							...
							<span>GST Number<br><span class="pack-abo"><?php echo e($user_details->gst_no); ?></span></span>
						</div>
					</div>
		...
		<span>PAN Number<br><span class="pack-abo"><?php echo e($user_details->pan_no); ?></span></span>
		</div>
		</div>
				</div>
	</div>
						...
						<div class="col-sm-12 col-lg-3 col-md-6 mb-3" style="<?php echo e(($key > 7 ? 'display:none;' : '')); ?>" <?php echo e(($key > 7 ? 'data-product-list' : '')); ?>>
							...
							<div class="product-item shadow">
								<div class="card">
									...
									<div class="card-body">
										<h4 class="card-title1"><a href="<?php echo e(URL::to('/product')); ?>/<?php echo e($product->product_slug); ?>" title="<?php echo e($product->product_name); ?>"><?php echo e($product->product_name); ?></a></h4>
...
<?php echo $__env->make('vendor-themes.theme-3.includes.footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/a0yq2z3dupoj/public_html/demo/resources/views/vendor-themes/theme-3/index.blade.php ENDPATH**/ ?>