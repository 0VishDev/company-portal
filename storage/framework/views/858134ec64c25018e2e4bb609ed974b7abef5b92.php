             ...
             <?php echo e(csrf_field()); ?>
                ...
                <div class="form-group row">
                    <div class="col-sm-6">
                        ...
                        <textarea name="product_short_desc" id="product_short_desc" rows="12" class="form-control noscroll_textarea" data-bvalidator="required,maxlen[160]" placeholder="Short description of the product within 70 words"></textarea>
                    </div>
                    <div class="col-sm-6">
                         <label for="site_desc"><?php echo e(Helper::translation(1931,$translate)); ?><span class="required">*</span></label>
                        <textarea name="product_desc" id="summary-ckeditor" rows="3"  class="form-control" data-bvalidator="required"></textarea>
                    </div>
                </div>
                <div class="form-group row">
                    <div class="col-sm-6">
                ...
                <div class="form-group row">
                    <div class="col-sm-6">
                         ...
                         <input type="file" id="product_image" name="product_image" class="form-control-file" data-bvalidator="required,extension[jpg:png:jpeg]" data-bvalidator-msg="<?php echo e(Helper::translation(1937,$translate)); ?>">
...
<?php endif; ?><?php /**PATH /home/inforrmz/venicered.com/resources/views/add-product.blade.php ENDPATH**/ ?>