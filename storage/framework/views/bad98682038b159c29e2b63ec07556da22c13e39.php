           ...
           <div class="col-lg-3 col-md-4 col-sm-6 mt-1 mb-1 pt-1 pb-1 prod-item">
    		    <div class="card shadow h-100 profile-card-2">
                    <div class="card-img-block">
                      <a href="<?php echo e(URL::to('/vr-'.str_slug($userNameSlug, '-'))); ?>" title="<?php echo e($seller->name); ?>">
                    ...
                    <div class="card-body pt-2">
                        ...
                        <h5><a href="<?php echo e(URL::to('/vr-'.str_slug($userNameSlug, '-'))); ?>" class="theme-color1"><?php echo e($userName); ?></a></h5>
                        <p class="card-text"><?php echo e(count($seller->products)); ?> <?php echo e(Helper::translation(1975,$translate)); ?></p>
                        <div><a href="<?php echo e(URL::to('/vr-'.str_slug($userNameSlug, '-'))); ?>" class="btn button-color"><?php echo e(Helper::translation(1977,$translate)); ?></a></div>
                    </div>
                </div>
             </div>
...
<?php endif; ?>
<?php /**PATH /home/a0yq2z3dupoj/public_html/demo/resources/views/best-sellers.blade.php ENDPATH**/ ?>