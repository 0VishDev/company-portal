...
<head>
  <title>Supplier By State - <?php echo e($allsettings->site_title); ?></title>
  ...
  <main role="main" class="main-content">
	...
	<section class="headerbg" style="background-image: url('<?php echo e(url('/')); ?>/public/storage/settings/<?php echo e($allsettings->site_header_background); ?>');">
      <div class="container text-left">
        ...
        <p class="mb-0"><a href="/">Home</a> <span class="split">&gt;</span> <span><?php echo e($state->state_name); ?></span></p>
      </div>
    </section>
...
<div class="row">
	<div class="col-sm-12">
	<h4 class="black mb-3 pb-3 mt-4 pt-4">Industrial & Manufacturing Hubs In <?php echo e($state->state_name); ?>
	...
	<div class="col-sm-6 col-md-4 col-lg-3 mb-3">
      <a href="<?php echo e(url('/')); ?>/city/<?php echo e(\ZigKart\Helpers::joinString($city->city_name)); ?>">
        <div class="rigion-name"><i class="fa fa-map-marker" aria-hidden="true"></i> <?php echo e($city->city_name); ?></div>
      </a>
		</div>
...
<?php endif; ?><?php /**PATH /home/a0yq2z3dupoj/public_html/demo/resources/views/regions.blade.php ENDPATH**/ ?>