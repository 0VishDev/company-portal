             ...
             <?php echo e(csrf_field()); ?>
                ...
                <div class="form-group row">
                    <div class="col-sm-6">
                        ...
                        <textarea name="product_short_desc" id="product_short_desc" rows="12" class="form-control noscroll_textarea" data-bvalidator="required,maxlen[160]"><?php echo e($edit['product']->product_short_desc); ?></textarea>
                    </div>
                    <div class="col-sm-6">
               ...
               <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                        <label for="minimum_order_unit">Minimum Order Unit</label>
...
<?php endif; ?>
<?php /**PATH /home/inforrmz/b2bkart.inforidgetechnologyindia.com/resources/views/edit-product.blade.php ENDPATH**/ ?>