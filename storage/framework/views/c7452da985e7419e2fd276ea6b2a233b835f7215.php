                                    ...
                                    <tbody>
                                        <?php $__currentLoopData = $metterSheets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $metterSheet): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                ...
                                                <td>
                                                  <button class="btn btn-danger mb-1" title="Download" data-download-b2b-metter-sheet sheet="<?php echo e($metterSheet); ?>"><span class="fa fa-download"></span></button>
                                                  <a href="<?php echo e(url('admin/b2b-sheet/'.$metterSheet->id.'/delete')); ?>" title="Delete" class="btn btn-danger mb-1" onClick="return confirm('Are you sure you want to delete?');"><span class="fa fa-trash"></span></a>
                                                </td>
                                            </tr> 
...
</html><?php /**PATH /home/a0yq2z3dupoj/public_html/resources/views/admin/b2b-sheet.blade.php ENDPATH**/ ?>