     ...
     <div class="col-lg-4 col-md-3 mb-3">
        <div class="block">
          ...
          <ul>
            ...
            <a href="sms:<?php echo e($user_details->mobile); ?>"><button type="button" class="btn btn-sm btn-theme2"><i class="fa fa-commenting-o" aria-hidden="true"></i> Send SMS</button></a>
            <a href="mailto:<?php echo e($user_details->email); ?>" class=" ml-3"><button type="button" class="btn btn-sm btn-theme2"><i class="fa fa-envelope" aria-hidden="true"></i> Send Email</button></a>
          </div>
        </div>
      </div>
...
</html><?php /**PATH /home/a0yq2z3dupoj/public_html/businessworldtrade.in/resources/views/vendor-themes/theme-2/includes/footer.blade.php ENDPATH**/ ?>