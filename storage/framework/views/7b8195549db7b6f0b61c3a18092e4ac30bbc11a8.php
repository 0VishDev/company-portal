                                ...
                                <table class="table table-striped table-bordered" id="callbackTable">
                                    ...
                                    <?php $__currentLoopData = $callbacks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $callback): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="#" class="btn btn-danger" title="Verify"><span class="fa fa-stop-circle-o"></span></a>
                                                <a href="<?php echo e(url('admin/callbacks/'.$callback->id.'/delete')); ?>"   title="Delete" class="btn btn-danger" onClick="return confirm('Are you sure you want to delete?');"><span class="fa fa-trash"></span></a>
                                            </td>
                                        </tr>
...
</html><?php /**PATH /home/ltqh13w2vszk/public_html/text/resources/views/admin/callbacks.blade.php ENDPATH**/ ?>