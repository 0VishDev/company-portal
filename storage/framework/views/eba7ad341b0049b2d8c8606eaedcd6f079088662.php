            ...
            <div class="swiper-slide">
              <div class="product-grid2">
                <div class="product-image2">
                  ...
                  <ul class="social">
                  <?php if(Auth::guest()): ?>
                    <li><a href="<?php echo e(url('/login')); ?>" data-tip="<?php echo e(Helper::translation(2066,$translate)); ?>"><i class="fa fa-heart"></i></a></li>
                  <?php else: ?>
                ...
                <div class="product-content">
                  ...
                  <?php else: ?>
                  <p class="fo-txt mt-3 mb-3 d-block"><button class="btn btn-blue text-white onGetBestPrice" data-target="#GetBestPrice" data-toggle="modal" data-product-id="<?php echo e($product->product_id); ?>" data-user-id="<?php if(!Auth::guest()): ?> <?php echo e(Auth::user()->id); ?> <?php endif; ?>" data-vendor-id="<?php echo e($product->user_id); ?>" data-image-url="<?php if($product->product_image != ""): ?> <?php echo e(url('/')); ?>/public/storage/product/<?php echo e($product->product_image); ?> <?php endif; ?>" data-vendor-name="<?php echo e(\ZigKart\User::where(["id" => $product->user_id])->first()->name); ?>" data-price="<?php echo e($product->product_price); ?>" data-product-name="<?php echo e($product->product_name); ?>">Get Best Price</button></p>
                  <?php endif; ?>
                </div>
              </div>
            </div>
                  ...
                  <div class="col-md-4 con-bg12">
                    <div class="contact-info">
                      <div class="text-center">
                        ...
                        <span><?php echo e($allsettings->site_currency_symbol); ?> <span id="popPrice"></span></span><br>
...
<?php endif; ?><?php /**PATH /home/inforrmz/b2bkart.inforidgetechnologyindia.com/resources/views/index.blade.php ENDPATH**/ ?>