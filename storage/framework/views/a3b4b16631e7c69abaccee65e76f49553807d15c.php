                ...
                <div class="row">
                   <div class="col-md-12">
                       <div class="card">
                                ...
                                <div id="pay-invoice">
                                    <div class="card-body">
                                       <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                <label for="site_desc" class="control-label mb-1">Meta Description (max 250 chars) <span class="require">*</span></label>
                                            <textarea name="site_desc" id="site_desc" rows="6" placeholder="site description" class="form-control noscroll_textarea" data-bvalidator="required,maxlen[250]"><?php echo e($setting['setting']->site_desc); ?></textarea></div>
                                               <div class="form-group">
                                                <label for="site_keywords" class="control-label mb-1">Meta Keywords (max 950 chars) <span class="require">*</span></label>
                                             <textarea name="site_keywords" id="site_keywords" rows="6" placeholder="separate keywords with commas" class="form-control noscroll_textarea" data-bvalidator="required,maxlen[950]"><?php echo e($setting['setting']->site_keywords); ?></textarea>
                                            </div>  
                                            <div class="form-group">
                                                <label for="site_logo" class="control-label mb-1">Header Background (size 1920 x 500) <span class="require">*</span></label>
                                            <input type="file" id="site_header_background" name="site_header_background" class="form-control-file" <?php if($setting['setting']->site_header_background == ''): ?> data-bvalidator="required,extension[jpg:png:jpeg]" data-bvalidator-msg="Please select file of type .jpg, .png or .jpeg" <?php else: ?> data-bvalidator="extension[jpg:png:jpeg]" data-bvalidator-msg="Please select file of type .jpg, .png or .jpeg" <?php endif; ?>><?php if($setting['setting']->site_header_background != ''): ?>
                                            ...
                                            <div class="form-group">
                                               ...
                                               <select name="product_approval" class="form-control" data-bvalidator="required">
                                                <option value=""></option>
                                                <option value="1" <?php if($setting['setting']->product_approval == 1): ?> selected <?php endif; ?>>Yes</option>
                                                <option value="0" <?php if($setting['setting']->product_approval == 0): ?> selected <?php endif; ?>>No</option>
                                                </select>
                                             </div>
                                             <div class="form-group">
                                                <label for="site_keywords" class="control-label mb-1">Cookie Popup Text <span class="require">*</span></label>
                                             <textarea name="cookie_popup_text" id="cookie_popup_text" rows="5" class="form-control noscroll_textarea" data-bvalidator="required"><?php echo e($setting['setting']->cookie_popup_text); ?></textarea>
                                            </div>
                                            <div class="form-group">
                                      ...
                                      <label for="product_approval" class="control-label mb-1">Maintenance Mode?<span class="require">*</span></label><br/>
                                       <select name="maintenance_mode" class="form-control" data-bvalidator="required">
                                                <option value=""></option>
                                                <option value="1" <?php if($setting['setting']->maintenance_mode == 1): ?> selected <?php endif; ?>>Yes</option>
                                                <option value="0" <?php if($setting['setting']->maintenance_mode == 0): ?> selected <?php endif; ?>>No</option>
                                                </select>
                                ...
                                <div id="pay-invoice">
                                    <div class="card-body">
                                       <div class="form-group">
                                            ...
                                            <input type="file" id="site_favicon" name="site_favicon" class="form-control-file" <?php if($setting['setting']->site_favicon == ''): ?> data-bvalidator="required,extension[jpg:png:jpeg]" data-bvalidator-msg="Please select file of type .jpg, .png or .jpeg" <?php else: ?> data-bvalidator="extension[jpg:png:jpeg]" data-bvalidator-msg="Please select file of type .jpg, .png or .jpeg" <?php endif; ?>>
                                            ...
                                            <input type="file" id="site_logo" name="site_logo" class="form-control-file" <?php if($setting['setting']->site_logo == ''): ?> data-bvalidator="required,extension[jpg:png:jpeg]" data-bvalidator-msg="Please select file of type .jpg, .png or .jpeg" <?php else: ?> data-bvalidator="extension[jpg:png:jpeg]" data-bvalidator-msg="Please select file of type .jpg, .png or .jpeg" <?php endif; ?>>
                                           ...
                                           <div class="form-group d-none">
                                               ...
                                               <select name="site_loader_display" class="form-control" data-bvalidator="required">
                                                <option value=""></option>
                                                <option value="1" <?php if($setting['setting']->site_loader_display == 1): ?> selected <?php endif; ?>>ON</option>
                                                <option value="0" <?php if($setting['setting']->site_loader_display == 0): ?> selected <?php endif; ?>>OFF</option>
                                                </select>
                                             </div>
                                           <div class="form-group">
                                   ...
                                   <div class="form-group">
                                      <label for="product_approval" class="control-label mb-1">Multi-Language?<span class="require">*</span></label><br/>
                                       <select name="google_translate" class="form-control" data-bvalidator="required">
                                                <option value=""></option>
                                                <option value="1" <?php if($setting['setting']->google_translate == 1): ?> selected <?php endif; ?>>Yes</option>
                                                <option value="0" <?php if($setting['setting']->google_translate == 0): ?> selected <?php endif; ?>>No</option>
                                                </select>
                                  </div> 
                                  <div class="form-group">
                                 ...
                                 <div class="form-group">
                                      <label for="product_approval" class="control-label mb-1">External Product?<span class="require">*</span></label><br/>
                                       <select name="display_external_product" class="form-control" data-bvalidator="required">
                                                <option value=""></option>
                                                <option value="1" <?php if($setting['setting']->display_external_product == 1): ?> selected <?php endif; ?>>ON</option>
                                                <option value="0" <?php if($setting['setting']->display_external_product == 0): ?> selected <?php endif; ?>>OFF</option>
                                                </select>
                                  </div>  
                                  <div class="form-group">
                           ...
                           <div class="col-md-12 d-none"><div class="card-body"><h4>Start Sellings</h4></div></div>
                                ...
                                <div id="pay-invoice">
                                    <div class="card-body">
                                       <div class="form-group">
                                               ...
                                               <input type="file" id="selling_background" name="selling_background" class="form-control-file"  <?php if($setting['setting']->selling_background == ''): ?> data-bvalidator="required,extension[jpg:png:jpeg]" data-bvalidator-msg="Please select file of type .jpg, .png or .jpeg" <?php else: ?> data-bvalidator="extension[jpg:png:jpeg]" data-bvalidator-msg="Please select file of type .jpg, .png or .jpeg" <?php endif; ?>><?php if($setting['setting']->selling_background != ''): ?>
                                             ...
                                             <div class="form-group">
                                               ...
                                               <input type="file" id="selling_image_one" name="selling_image_one" class="form-control-file"  <?php if($setting['setting']->selling_image_one == ''): ?> data-bvalidator="required,extension[jpg:png:jpeg]" data-bvalidator-msg="Please select file of type .jpg, .png or .jpeg" <?php else: ?> data-bvalidator="extension[jpg:png:jpeg]" data-bvalidator-msg="Please select file of type .jpg, .png or .jpeg" <?php endif; ?>><?php if($setting['setting']->selling_image_one != ''): ?>
                                             ...
                                             <div class="form-group">
                                               ...
                                               <input type="file" id="selling_image_two" name="selling_image_two" class="form-control-file"  <?php if($setting['setting']->selling_image_two == ''): ?> data-bvalidator="required,extension[jpg:png:jpeg]" data-bvalidator-msg="Please select file of type .jpg, .png or .jpeg" <?php else: ?> data-bvalidator="extension[jpg:png:jpeg]" data-bvalidator-msg="Please select file of type .jpg, .png or .jpeg" <?php endif; ?>><?php if($setting['setting']->selling_image_two != ''): ?>
                                ...
                                <div id="pay-invoice">
                                    <div class="card-body">
                                       <div class="form-group">
                                               ...
                                               <input type="file" id="selling_icon_one" name="selling_icon_one" class="form-control-file"  <?php if($setting['setting']->selling_icon_one == ''): ?> data-bvalidator="required,extension[jpg:png:jpeg]" data-bvalidator-msg="Please select file of type .jpg, .png or .jpeg" <?php else: ?> data-bvalidator="extension[jpg:png:jpeg]" data-bvalidator-msg="Please select file of type .jpg, .png or .jpeg" <?php endif; ?>><?php if($setting['setting']->selling_icon_one != ''): ?>
                                             ...
                                             <div class="form-group">
                                               ...
                                               <input type="file" id="selling_icon_two" name="selling_icon_two" class="form-control-file"  <?php if($setting['setting']->selling_icon_two == ''): ?> data-bvalidator="required,extension[jpg:png:jpeg]" data-bvalidator-msg="Please select file of type .jpg, .png or .jpeg" <?php else: ?> data-bvalidator="extension[jpg:png:jpeg]" data-bvalidator-msg="Please select file of type .jpg, .png or .jpeg" <?php endif; ?>><?php if($setting['setting']->selling_icon_two != ''): ?>
                                             ...
                                             <div class="form-group">
                                               ...
                                               <input type="file" id="selling_icon_three" name="selling_icon_three" class="form-control-file"  <?php if($setting['setting']->selling_icon_three == ''): ?> data-bvalidator="required,extension[jpg:png:jpeg]" data-bvalidator-msg="Please select file of type .jpg, .png or .jpeg" <?php else: ?> data-bvalidator="extension[jpg:png:jpeg]" data-bvalidator-msg="Please select file of type .jpg, .png or .jpeg" <?php endif; ?>><?php if($setting['setting']->selling_icon_three != ''): ?>
...
</html><?php /**PATH /home/ltqh13w2vszk/public_html/text/resources/views/admin/general-settings.blade.php ENDPATH**/ ?>