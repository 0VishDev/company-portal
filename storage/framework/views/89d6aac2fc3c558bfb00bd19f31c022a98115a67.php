...
<body>
  ...
  <main role="main" class="main-content">
    ...
    <div class="container-fluid mt-3">
        <div class="row">
        	<div class="col-sm-12">
        	<h4 class="black mb-3 pb-3 mt-4 pt-4">Industries & Manufacturing Companies In <?php echo e($city->city_name); ?>
        	...
        	<div class="row">
        		...
        		<ul class="trending-ads-slide">
                      <?php $__currentLoopData = $categoryAll; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <li><a href="#<?php echo e($category['category_slug']); ?>"><img src="<?php echo e(url('/')); ?>/public/storage/category/<?php echo e($category['category_image']); ?>"> <?php echo e($category['category_name']); ?></a></li>
        ...
        <?php $__currentLoopData = $categoryAll; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    		<div class="shadow bg-white pr-3 pl-3 pb-4 mb-3 hub" id="<?php echo e($category['category_slug']); ?>">
              ...
              <div class="col-sm-12 col-md-12 col-lg-12 mb-3">
                <h4 class="black pb-2 mt-2 pt-2"><img src="<?php echo e(url('/')); ?>/public/storage/category/<?php echo e($category['category_image']); ?>"> <?php echo e($category['category_name']); ?></h4>
                </div>
                <?php $__currentLoopData = $category['subCategories']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subcategory): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="col-sm-6 col-md-4 col-lg-3 mb-3">
                        <h6><?php echo e($subcategory['subcategory_name']); ?></h6>
                         <?php $__currentLoopData = $subcategory['products']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <p><a href="<?php echo e(url('product/'.$product['product_slug'])); ?>"><?php echo e($product['product_name']); ?></a></p>
                         <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
              </div>
...
<script src="/public/css/jquery.min.js"></script>
  <!-- tether js -->
<script src="/public/css/slick.min.js"></script>
<script src="/public/css/jquery.nice-select.min.js"></script>

<script src="/public/css/script.js"></script>
</html>
<?php else: ?>
<?php echo $__env->make('503', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php endif; ?><?php /**PATH /home/inforrmz/venicered.com/resources/views/region.blade.php ENDPATH**/ ?>