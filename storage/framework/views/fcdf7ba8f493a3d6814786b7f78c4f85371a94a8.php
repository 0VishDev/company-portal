...
<html lang="en">
  ...
  <body>
    ...
    <div class="container-fluid mt-3">
      <div class="bg-white shadow pt-4 pb-4">
        <form class="up-leads11" action="<?php echo e(url('freights/add')); ?>" method="POST" id="freightsForm">
          <?php echo csrf_field(); ?>
                  ...
                  <table width="100%" border="0" cellpadding="4" cellspacing="1" class="tbl-tr table tbl-get">
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td class="">
                          <textarea rows="2" cols="30" name="freights[air][product_desc]" data-air-input></textarea>
                        </td>
                      </tr>
                      <tr>
  ...
  <script>
    var isLogin = '<?php echo e((Auth::check() ? 1 : 0)); ?>';
    var isModalOpen = 0;
...
<?php endif; ?><?php /**PATH /home/ltqh13w2vszk/public_html/text/resources/views/freights.blade.php ENDPATH**/ ?>