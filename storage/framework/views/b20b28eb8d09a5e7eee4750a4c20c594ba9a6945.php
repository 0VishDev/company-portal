                                       ...
                                       <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <label for="theme_1"><input type="radio" name="theme" value="theme-1" id="theme_1"> Theme 1</label>
                                                    <label for="theme_2"><input type="radio" name="theme" value="theme-2" id="theme_2"> Theme 2</label>
                                                    <label for="theme_3"><input type="radio" name="theme" value="theme-3" id="theme_3"> Theme 3</label>
                                                    <label for="theme_4"><input type="radio" name="theme" value="theme-4" id="theme_4"> Theme 4</label>
                                                </div>
                                                <div class="form-group">
...
</html><?php /**PATH /home/ltqh13w2vszk/public_html/text/resources/views/admin/edit-vendor.blade.php ENDPATH**/ ?>