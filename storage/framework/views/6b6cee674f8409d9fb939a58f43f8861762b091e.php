                                ...
                                <div id="pay-invoice">
                                    <div class="card-body">
                                       <div class="form-group">
                                            ...
                                            <input id="category_name" name="category_name" type="text" class="form-control" value="<?php echo e($edit['category']->category_name); ?>" data-bvalidator="required">
                                        </div>
                                       <div class="form-group">
                                            ...
                                            <option value=""></option>
                                            <option value="1" <?php if($edit['category']->category_status == 1): ?> selected="selected" <?php endif; ?>>Active</option>
                                            <option value="0" <?php if($edit['category']->category_status == 0): ?> selected="selected" <?php endif; ?>>InActive</option>
                                            </select>
                                        </div>
                                        <div class="form-group">
                                            <label for="name" class="control-label mb-1">SEO Title <span class="require">*</span></label>
                                            <input id="seo_title" name="seo_title" type="text" class="form-control" value="<?php echo e($edit['category']->seo_title); ?>">
                                        </div>
                                        <div class="form-group">
                                            <label for="site_title" class="control-label mb-1"> SEO Keywords</label>
                                            <textarea name="seo_keywords" id="seo_keywords" class="form-control"><?php echo e($edit['category']->seo_keywords); ?></textarea>
                                        </div>
                                   </div>
                                </div>
                              </div>
                            ...
                            <div class="card-body">
                                ...
                                <div id="pay-invoice">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="file" id="category_image" name="category_image" class="form-control-file" data-bvalidator="extension[jpg:png:jpeg]" data-bvalidator-msg="Please select file of type .jpg, .png or .jpeg"></div><?php if($edit['category']->category_image != ''): ?><img height="50" src="<?php echo e(url('/')); ?>/public/storage/category/<?php echo e($edit['category']->category_image); ?>"  /><?php else: ?> <img height="50" src="<?php echo e(url('/')); ?>/public/img/no-image.jpg"  /><?php endif; ?>
                                    </div>
                                    <div class="form-group">
                                        <label for="site_title" class="control-label mb-1"> SEO Meta Description</label>
                                        <textarea name="seo_meta_description" id="seo_meta_description" class="form-control"><?php echo e($edit['category']->seo_meta_description); ?></textarea>
                                     </div>
                                </div>
                              </div>
...
</html><?php /**PATH /home/a0yq2z3dupoj/public_html/businessworldtrade.in/resources/views/admin/edit-category.blade.php ENDPATH**/ ?>