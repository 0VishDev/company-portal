    ...
    <div class="row">
      ...
      <div class="col-lg-4 col-md-3 mb-3">
        <div class="block">
          ...
          <ul>
            ...
            <li><a href="<?php echo e($user_details->company_website); ?>"><?php echo e($user_details->company_website); ?></a></li>
            <li><a>Visitors (<?php echo e($visitCount); ?>)</a></li>
          </ul>
        </div>
      </div>
      <!-- Link list -->
      <div class="col-lg-4 col-md-3 mb-3">
        <div class="block">
          <h4>Reach Us</h4>
          <ul>
			  <li><b><?php echo e($user_details->name); ?></b></li>
            <li><?php echo e($user_details->user_address); ?></li>
          </ul>
			<div class="download-btn d-flex my-3">
            <a href="sms:<?php echo e($user_details->mobile); ?>"><button type="button" class="btn btn-sm btn-theme3"><i class="fa fa-commenting-o" aria-hidden="true"></i> Send SMS</button></a>
            <a href="mailto:<?php echo e($user_details->email); ?>" class=" ml-3"><button type="button" class="btn btn-sm btn-theme3"><i class="fa fa-envelope" aria-hidden="true"></i> Send Email</button></a>
          </div>
        </div>
      </div>
      ...
      <div class="col-lg-3 col-md-3 mb-3">
        <div class="block">
          <?php if(!empty($user_details->facebook_link) || !empty($user_details->linkedin_link) || !empty($user_details->instagram_link) || !empty($user_details->twitter_link)): ?>
              <h4>Share us via</h4>
              <div class="download-btn d-flex mb-4">
                 <?php if(!empty($user_details->facebook_link)): ?>
                    <a href="<?php echo e($user_details->facebook_link); ?>" target="_blank"><img src="<?php echo e(url('/')); ?>/public/img/facebook.png" alt="facebook"></a>
                 <?php endif; ?>
                 
                 <?php if(!empty($user_details->linkedin_link)): ?>
                    <a href="<?php echo e($user_details->linkedin_link); ?>" target="_blank" class=" ml-3"><img src="<?php echo e(url('/')); ?>/public/img/linklen.png" alt="linkedin"></a>
                 <?php endif; ?>
                 
                 <?php if(!empty($user_details->instagram_link)): ?>
                    <a href="<?php echo e($user_details->instagram_link); ?>" target="_blank" class=" ml-3"><img src="<?php echo e(url('/')); ?>/public/img/instagram.png" alt="instagram"></a>
                 <?php endif; ?>
                 
                 <?php if(!empty($user_details->twitter_link)): ?>
                    <a href="<?php echo e($user_details->twitter_link); ?>" target="_blank" class=" ml-3"><img src="<?php echo e(url('/')); ?>/public/img/twitter.png" alt="twitter"></a>
                 <?php endif; ?>
              </div>
           <?php endif; ?>
    ...
    <div class="row">
      ...
      <div class="col-sm-6 col-12">
        ...
        <ul class="social-media-icons float-right">
          <li>Managed and Developed by <a href="<?php echo e(url('/')); ?>">Infobiz World Trade Pvt. Ltd.</a></li>
        </ul>
      </div>
    </div>
  </div>
...
<!-- JAVASCRIPTS -->
<script src="<?php echo e(asset('resources/views/template/vendor-themes/theme-3/plugins/jQuery/jquery.min.js')); ?>"></script>
<script src="<?php echo e(asset('resources/views/template/vendor-themes/theme-3/plugins/bootstrap/js/popper.min.js')); ?>"></script>
<script src="<?php echo e(asset('resources/views/template/vendor-themes/theme-3/plugins/bootstrap/js/bootstrap.min.js')); ?>"></script>
<script src="<?php echo e(asset('resources/views/template/vendor-themes/theme-3/plugins/bootstrap/js/bootstrap-slider.js')); ?>"></script>
  <!-- tether js -->
<script src="<?php echo e(asset('resources/views/template/vendor-themes/theme-3/plugins/tether/js/tether.min.js')); ?>"></script>
<script src="<?php echo e(asset('resources/views/template/vendor-themes/theme-3/plugins/raty/jquery.raty-fa.js')); ?>"></script>
<script src="<?php echo e(asset('resources/views/template/vendor-themes/theme-3/plugins/slick-carousel/slick/slick.min.js')); ?>"></script>
<script src="<?php echo e(asset('resources/views/template/vendor-themes/theme-3/plugins/jquery-nice-select/js/jquery.nice-select.min.js')); ?>"></script>
<script src="<?php echo e(asset('resources/views/template/vendor-themes/theme-3/plugins/fancybox/jquery.fancybox.pack.js')); ?>"></script>
<script src="<?php echo e(asset('resources/views/template/vendor-themes/theme-3/plugins/smoothscroll/SmoothScroll.min.js')); ?>"></script>
<!-- google map -->
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCcABaamniA6OL5YvYSpB3pFMNrXwXnLwU&libraries=places"></script>
<script src="<?php echo e(asset('resources/views/template/vendor-themes/theme-3/plugins/google-map/gmap.js')); ?>"></script>
<script src="<?php echo e(asset('resources/views/template/vendor-themes/theme-3/js/script.js')); ?>"></script>
...
</html><?php /**PATH /home/a0yq2z3dupoj/public_html/resources/views/vendor-themes/theme-3/includes/footer.blade.php ENDPATH**/ ?>