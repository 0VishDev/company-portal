                                    ...
                                    <tbody>
                                        <?php $__currentLoopData = $distributorshipSheets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $distributorshipSheet): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                ...
                                                <td>
                                                  <button class="btn btn-danger" title="Download" data-download-distributorship-metter-sheet sheet="<?php echo e($distributorshipSheet); ?>"><span class="fa fa-download"></span></button>
                                                  <a href="<?php echo e(url('admin/distributorship-sheet/'.$distributorshipSheet->id.'/delete')); ?>" title="Delete" class="btn btn-danger" onClick="return confirm('Are you sure you want to delete?');"><span class="fa fa-trash"></span></a>
                                                </td>
                                            </tr> 
...
</html><?php /**PATH /home/ltqh13w2vszk/public_html/text/resources/views/admin/distributorship-sheet.blade.php ENDPATH**/ ?>