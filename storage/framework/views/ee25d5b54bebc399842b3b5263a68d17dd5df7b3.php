                            ...
                            <div class="card-body">
                                <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                    ...
                                    <?php $__currentLoopData = $inquiries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $inquiry): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php
                                            $product = \ZigKart\Models\Product::where(["product_id" => $inquiry->product_id])->first();
                                            $user = \ZigKart\User::where(["id" => $inquiry->user_id])->first();
                                        ?>
                                        <tr>
                                            <td><?php echo e($user->name); ?></td>
                                            <td><?php echo e($product->product_name); ?></td>
                                            <td><?php echo e($inquiry->quantity); ?></td>
                                            <td><?php echo e($inquiry->order_value); ?></td>
                                            <td><?php echo e($inquiry->payment_method); ?></td>
                                            <td>
...
</html><?php /**PATH /home/inforrmz/b2bkart.inforidgetechnologyindia.com/resources/views/admin/inquiries.blade.php ENDPATH**/ ?>