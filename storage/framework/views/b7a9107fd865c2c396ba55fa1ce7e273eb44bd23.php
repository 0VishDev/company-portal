             ...
             <ul class="countdown-<?php echo e($shop->product_token); ?>" id="countdown-timer">
                                         ...
                                         <?php if($shop->product_type != 'digital'): ?>
                                           <span>
                                              ...
                                              <input type="number" name="qty" class="form-control qty_box" data-bvalidator="required,min[1],max[<?php echo e($shop->product_stock); ?>]" value="1">
                                           </span>
                                          <?php else: ?>
                                          ...
                                          <?php endif; ?> 
                                           ...
                                           <span>
                                              ...
                                              <select name="product_attribute[]" class="form-control qty_box">
                                                 ...
                                                 <option value="<?php echo e($product_value->attribute_value_id); ?>_<?php echo e($attribute->attribute_name); ?> - <?php echo e($product_value->attribute_value); ?>"><?php echo e($product_value->attribute_value); ?></option>                                      <?php endif; ?>
                                                 <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                             </select>
                                           </span>
                                           <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php endif; ?><?php /**PATH /home/inforrmz/zigkart.inforidgetechnologyindia.com/resources/views/product.blade.php ENDPATH**/ ?>