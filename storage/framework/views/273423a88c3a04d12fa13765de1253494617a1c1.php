                                    ...
                                    <tbody>
                                        ...
                                        <?php $__currentLoopData = $distributorships; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $distributorship): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <td><?php echo e(++$no); ?></td>
                                                ...
                                                <td><?php echo e($distributorship->comment); ?></td>
                                                
                                                <td><?php echo e(\Carbon\Carbon::parse($distributorship->created_at)->format('d M, Y g:i A')); ?></td>
                                                <td>
                                                    <button class="btn btn-danger mb-1" title="Add Comment" data-comment-add inquiry-id="<?php echo e($distributorship->id); ?>" comment="<?php echo e($distributorship->comment); ?>"><span class="fa fa-commenting-o"></span></button>
                                                    
                                                    <?php if($distributorship->is_verify == 0): ?>
                                                        <a href="<?php echo e(url('admin/distributorships/'.$distributorship->id.'/verify')); ?>" class="btn btn-danger mb-1" title="Verify"><span class="fa fa-stop-circle-o"></span></a>
                                                    <?php endif; ?>
                                                    <a href="<?php echo e(url('admin/distributorships/'.$distributorship->id.'/delete')); ?>" title="Delete" class="btn btn-danger mb-1" onClick="return confirm('Are you sure you want to delete?');"><span class="fa fa-trash"></span></a>
                                                </td>
                                            </tr> 
      ...
      <div class="modal-dialog modal-sm modal-dialog-centered " role="document">
        <div class="modal-content">
          <div class="modal-header">
           ...
           <form action="<?php echo e(url('admin/distributorships/comment/add')); ?>" method="POST" enctype="multipart/form-data">
               <?php echo csrf_field(); ?>
...
</html><?php /**PATH /home/ltqh13w2vszk/public_html/resources/views/admin/distributorships.blade.php ENDPATH**/ ?>