	...
	<div class="container ven-dash desk">
		<div class="bg-white pl-2 pt-4 pb-4 pr-4 mb-2">
			<div class="row">
				...
				<div class="row">
				    <div class="col-sm-9">
				        <h4>Buy Leads: <?php if(count(\Auth::user()->package_tags) > 0): ?>
                        	     <?php $__currentLoopData = \Auth::user()->package_tags; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $packageTag): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php echo e($packageTag->service_provider->total_lead); ?>
...
<?php echo $__env->make('vendor-dash.bottom-links', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ltqh13w2vszk/public_html/resources/views/vendor-dash/consumed-leads.blade.php ENDPATH**/ ?>