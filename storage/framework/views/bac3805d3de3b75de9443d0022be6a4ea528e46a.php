...
<head>
  ...
  <!-- FAVICON -->
  <link href="<?php echo e(asset('resources/views/template/vendor-themes/theme-3/img/favicon.png')); ?>" rel="shortcut icon">
  <!-- Bootstrap -->
...
<input type="hidden" name="base_path" id="base_path" value="<?php echo e(url('/')); ?>"><?php /**PATH /home/inforrmz/venicered.com/resources/views/vendor-themes/theme-3/includes/header.blade.php ENDPATH**/ ?>