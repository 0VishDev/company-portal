                    ...
                    <div class="col-md-3">
                        <div class="profile-img">
                            <?php if(!empty($user->user_photo)): ?>
                                <img src="<?php echo e(url('/')); ?>/public/storage/users/<?php echo e($user->user_photo); ?>" class="rounded" alt="<?php echo e($user->name); ?>">
                            <?php else: ?>
                                <img src="<?php echo e(url('/')); ?>/public/img/no-image.jpg" class="rounded" alt="<?php echo e($user->name); ?>">
                            <?php endif; ?>   
                        </div>
                        <div class="row mt-3">
                                            <div class="col-md-4">
                       ...
                       <div class="col-md-9 ash-bg">
                        <div class="profile-banner">
                          <?php if(!empty($user->user_banner)): ?>
                                <img src="<?php echo e(url('/')); ?>/public/storage/users/<?php echo e($user->user_banner); ?>" class="" alt="<?php echo e($user->name); ?>">
                            <?php else: ?>
                                <img src="<?php echo e(url('/')); ?>/public/img/no-image.jpg" class="" alt="<?php echo e($user->name); ?>">
                            <?php endif; ?> 
                         </div>
...
<?php endif; ?><?php /**PATH /home/a0yq2z3dupoj/public_html/resources/views/buyer.blade.php ENDPATH**/ ?>