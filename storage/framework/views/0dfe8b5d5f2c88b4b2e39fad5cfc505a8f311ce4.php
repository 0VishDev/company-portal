           ...
           <div class="col-md-3">
                      ...
                      <div class="row">
                        <div class="col-lg-12">
                            <select data-control-type="sort-select" data-control-name="sort" data-control-action="sort" class="form-control">
                              <option data-path=".like" data-order="asc" data-type="number"><?php echo e(Helper::translation(2163,$translate)); ?></option>
                              <option data-path=".like" data-order="desc" data-type="number"><?php echo e(Helper::translation(2164,$translate)); ?></option>
                           </select>
                        </div>
                      </div>
                    </div>
                      ...
                      <div class="row">
                        <div class="col-lg-12">
                          <div 
						   ...
						   data-control-action="filter"
						   data-control-name="themes">
                            <input type="checkbox" name="condition" data-path=".new" id="new"> <?php echo e(Helper::translation(1951,$translate)); ?><br/>
                            <input type="checkbox" name="condition" data-path=".used" id="used"> <?php echo e(Helper::translation(1952,$translate)); ?>
                      ...
                      <div class="row">
                        <div class="col-lg-12">
                          <div 
						   ...
						   data-control-action="filter"
						   data-control-name="themes">
                            <input type="checkbox" name="product_type" data-path=".physical" id="physical"> <?php echo e(Helper::translation(2165,$translate)); ?><br/>
                            <input type="checkbox" name="product_type" data-path=".external" id="external"> <?php echo e(Helper::translation(2166,$translate)); ?><br/>
                            <input type="checkbox" name="product_type" data-path=".digital" id="digital"> <?php echo e(Helper::translation(2167,$translate)); ?><br/>
                           </div>
                        </div>
                    ...
                    <div class="card-body">
                      <div class="row">
                        ...
                        <?php $__currentLoopData = $attribute->attributevalue; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product_value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <input type="checkbox" name="attribute[]" value="<?php echo e($product_value->attribute_value_id); ?>" data-path=".<?php echo e($product_value->attribute_value_id); ?>" id="<?php echo e($product_value->attribute_value_id); ?>"> <?php echo e($product_value->attribute_value); ?><br/>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?> 
                        </div>   
                        </div>
                      </div>
            ...
            <?php if($product->product_condition != ""): ?><div class="mt-2"><?php echo e(Helper::translation(1950,$translate)); ?> : <span class="<?php echo e($badg); ?>"><?php echo e($product->product_condition); ?></span></div><?php endif; ?>
                                    ...
                                    <a href="<?php echo e(URL::to('/product')); ?>/<?php echo e($product->product_slug); ?>">
                                            ...
                                            <?php else: ?>
                                            <p class="fo-txt mt-3 mb-3 d-block"><button class="btn btn-blue text-white onGetBestPrice" data-target="#GetBestPrice" data-toggle="modal" data-product-id="<?php echo e($product->product_id); ?>" data-user-id="<?php echo e($product->user_id); ?>">Get Best Price</button></p>
                                            <?php endif; ?>
...
<?php endif; ?><?php /**PATH /home/inforrmz/b2bkart.inforidgetechnologyindia.com/resources/views/shop.blade.php ENDPATH**/ ?>