            ...
            <div class="card-body">
              ...
              <div class="blog-meta">
                  <div class="blog-icon-view">
                        ...
                        <p class="comment"><i class="fa fa-comments"></i> <?php echo e($comments->has($post->post_id) ? count($comments[$post->post_id]) : 0); ?></p>
...
<?php endif; ?><?php /**PATH /home/inforrmz/b2bkart.inforidgetechnologyindia.com/resources/views/blog.blade.php ENDPATH**/ ?>