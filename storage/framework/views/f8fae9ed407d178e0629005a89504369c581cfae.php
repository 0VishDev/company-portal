                                ...
                                <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                    ...
                                    <?php $__currentLoopData = $userData['data']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td><a href="edit-vendor/<?php echo e($user->user_token); ?>" class="btn btn-success btn-sm mb-1"><i class="fa fa-edit"></i>&nbsp; Edit</a>
                                            <?php if($demo_mode == 'on'): ?> 
                                            <a href="demo-mode" class="btn btn-danger btn-sm mb-1"><i class="fa fa-trash"></i>&nbsp;Delete</a>
                                            <?php else: ?> 
                                            <a href="vendor/<?php echo e($user->user_token); ?>" class="btn btn-danger btn-sm" onClick="return confirm('Are you sure you want to delete?');"><i class="fa fa-trash"></i>&nbsp;Delete</a><?php endif; ?></td></tr><?php $no++; ?>
...
</html><?php /**PATH /home/ltqh13w2vszk/public_html/text/resources/views/admin/vendor.blade.php ENDPATH**/ ?>