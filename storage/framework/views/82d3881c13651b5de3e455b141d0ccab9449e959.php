                      ...
                      <div class="card">
                                ...
                                <div id="pay-invoice">
                                    <div class="card-body">
                                      <div class="form-group">
                                            ...
                                            <input type="file" id="site_more_category" name="site_more_category" class="form-control-file" data-bvalidator="extension[jpg:png:jpeg]" data-bvalidator-msg="Please select file of type .jpg, .png or .jpeg"><?php if($setting['setting']->site_more_category != ''): ?>
                           ...
                           <div class="card-body">
                                ...
                                <div id="pay-invoice">
                                    <div class="card-body">
                                    <div class="form-group">
                                                <label for="site_title" class="control-label mb-1">Display?<span class="require">*</span></label><br/>
                                                 <select name="site_home_top_banner" class="form-control" data-bvalidator="required">
                                                <option value=""></option>
                                                <option value="1" <?php if($setting['setting']->site_home_top_banner == 1): ?> selected <?php endif; ?>>ON</option>
                                                <option value="0" <?php if($setting['setting']->site_home_top_banner == 0): ?> selected <?php endif; ?>>OFF</option>
                                         </select>
                                      </div>
                                      <div class="form-group">
                                                <label for="site_title" class="control-label mb-1">Banner One (size : 630 X 250px )</label>
                                                <input type="file" id="site_banner_one" name="site_banner_one" class="form-control-file" data-bvalidator="extension[jpg:png:jpeg]" data-bvalidator-msg="Please select file of type .jpg, .png or .jpeg"><?php if($setting['setting']->site_banner_one != ''): ?>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input id="site_banner_one_heading" name="site_banner_one_heading" type="text" class="form-control noscroll_textarea" value="<?php echo e($setting['setting']->site_banner_one_heading); ?>"></div><div class="form-group">
                                    ...
                                    <div class="card-body">
                                     <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input id="site_banner_two_heading" name="site_banner_two_heading" type="text" class="form-control noscroll_textarea" value="<?php echo e($setting['setting']->site_banner_two_heading); ?>"></div><div class="form-group">
                                ...
                                <div id="pay-invoice">
                                    <div class="card-body">
                                      <div class="form-group">
                                                ...
                                                <option value=""></option>
                                                <option value="1" <?php if($setting['setting']->site_home_bottom_banner == 1): ?> selected <?php endif; ?>>ON</option>
                                                <option value="0" <?php if($setting['setting']->site_home_bottom_banner == 0): ?> selected <?php endif; ?>>OFF</option>
                                         </select>
                                      </div>
                                      <div class="form-group">
                                                <label for="site_title" class="control-label mb-1">Banner Three (size : 1280 X 250px )</label>
                                                <input type="file" id="site_banner_three" name="site_banner_three" class="form-control-file" data-bvalidator="extension[jpg:png:jpeg]" data-bvalidator-msg="Please select file of type .jpg, .png or .jpeg"><?php if($setting['setting']->site_banner_three != ''): ?>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input id="site_banner_three_heading" name="site_banner_three_heading" type="text" class="form-control noscroll_textarea" value="<?php echo e($setting['setting']->site_banner_three_heading); ?>"></div><div class="form-group">
...
</html><?php /**PATH /home/inforrmz/zigkart.inforidgetechnologyindia.com/resources/views/admin/home-section.blade.php ENDPATH**/ ?>