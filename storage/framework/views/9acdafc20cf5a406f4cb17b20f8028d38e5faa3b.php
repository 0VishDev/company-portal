                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            <a href="<?php echo e(url('/admin/orders')); ?>" class="btn btn-success btn-sm"><i class="fa fa-chevron-left"></i> Back</a>
                        </ol>
                    </div>
                </div>
            </div>
                                ...
                                <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                    ...
                                    <?php $__currentLoopData = $itemData['item']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <a href="<?php echo e(URL::to('/admin/order-details')); ?>/<?php echo e($order->ord_id); ?>/vendor" class="btn btn-success btn-sm" title="payment released to vendor" onClick="return confirm('Are you sure you will payment released to vendor?');"><i class="fa fa-money"></i>&nbsp; Waiting for approval</a> 
                                            <a href="<?php echo e(URL::to('/admin/order-details')); ?>/<?php echo e($order->ord_id); ?>/buyer" class="btn btn-danger btn-sm" title="payment released to buyer" onClick="return confirm('Are you sure you will payment released to buyer?');"><i class="fa fa-close"></i>&nbsp;Cancel Approval</a>
                                            <?php else: ?>
                            ...
                            <table class="table table-hover table-striped table-align-middle mb-0">
                                ...
                                <tbody>
                                   ...
                                   <tr>
                                        ...
                                        <td>
                                            <?php echo e($single_data->payment_type); ?>
...
</html><?php /**PATH /home/inforrmz/b2bkart.inforidgetechnologyindia.com/resources/views/admin/order-details.blade.php ENDPATH**/ ?>