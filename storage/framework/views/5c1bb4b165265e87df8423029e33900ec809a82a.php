    ...
    <div class="row pb-1">
      <div id="logo" class="col-lg-3 col-md-2 col-sm-4 pt-1">
        ...
        <a href="<?php echo e(URL::to('/')); ?>">
            <img src="<?php echo e(asset('public/img/new-img/svg-logo.svg')); ?>" class="img-fluid" type="image/svg+xml">
          ...
          <ul class="nav-menu">
            ...
            <li class="menu-has-children">
              ...
              <ul class="has-chil">
                ...
                <li class="nav-item"><a href="<?php echo e(url('wtc-certificate')); ?>">WTC Certificate</a></li>
                <!--<li class="nav-item"><a href="<?php echo e(url('scratch')); ?>">Share Scratch Card</a></li>
                <li class="nav-item"><a href="<?php echo e(url('latest-package')); ?>">Latest Package</a></li>-->
                <li class="nav-item"><a href="<?php echo e(url('export-data')); ?>">Export Data</a></li>
              </ul>
            </li>
...
<!--whats app icon -->
<div id="mybutton">
    <a href="https://api.whatsapp.com/send?phone=917011224810" class="whatsapp" target="_blank"><img class="feedback" src="<?php echo e(asset('public/img/whatsapp.png')); ?>" width="60px" height="60px"></a> 
 </div>
...
<div class="quote animated rotatePulses infinite slower"> <a href="<?php echo e(url('advertise-us')); ?>"  title="Infobiz World Trade"> <span>Premium Packages</span></a> </div>
<?php /**PATH /home/a0yq2z3dupoj/public_html/businessworldtrade.in/resources/views/header.blade.php ENDPATH**/ ?>