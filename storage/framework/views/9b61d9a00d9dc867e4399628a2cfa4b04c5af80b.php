			...
			<div class="row">
				...
				<aside class="col-sm-4 col-md-3 col-lg-2 white">
					...
					<ul class="list-unstyled">
						...
						<li> <a href="<?php echo e(URL::to('/venicered-lending/business-loan')); ?>" target="_blank"> Business Loan</a></li>
                        <li> <a href="<?php echo e(URL::to('/venicered-lending/business-insurance')); ?>" target="_blank"> Business Insurance </a></li>
                        <li> <a href="<?php echo e(URL::to('/venicered-lending/iso-certification')); ?>" target="_blank"> ISO Certification </a></li>
                        <li> <a href="<?php echo e(URL::to('/logistics')); ?>" target="_blank"> VR Logistics </a></li>
                        <li> <a href="<?php echo e(URL::to('/venicered-lending/e-filing')); ?>" target="_blank"> E-Filing </a></li>
                        <li> <a href="<?php echo e(URL::to('/venicered-lending/jobs')); ?>" target="_blank"> VR Jobs </a></li>
					</ul>
				</aside>
				<aside class="col-sm-4 col-md-3 col-lg-2 white">
					...
					<ul class="list-unstyled">
                        ...
                        <li> <a href="<?php echo e(URL::to('/mettersheets/b2b')); ?>"> VR B2B</a></li>
                        <li> <a href="<?php echo e(URL::to('/mettersheets/distributorship')); ?>"> VR Distributorship </a></li>
					</ul>
				</aside>
					<aside class="col-sm-4 col-md-3 col-lg-3 white">
					    <h2 class="title">Supplier </h2>
					<ul class="list-unstyled">
					    <li><a href="<?php echo e(URL::to('/shop')); ?>">Display New Product </a></li>
                        ...
                        <li> <a href="<?php echo e(URL::to('/vr-trust')); ?>"> VR Trust Certificate</a></li>
					</ul>
				</aside>
					<aside class="col-sm-4 col-md-3 col-lg-3 white">
...
<div class="modal fade show" id="12" aria-modal="true" >
    <div class="modal-dialog modal-lg modal-dialog-centered " role="document">
        <div class="modal-content">
            <div class="modal-header bg-red">
...
</script><?php /**PATH /home/ltqh13w2vszk/public_html/text/resources/views/footer.blade.php ENDPATH**/ ?>