...
<!-- Right Panel -->
    ...
    <div id="right-panel" class="right-panel">
     ...
     <?php $__currentLoopData = $productInquiry; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $inquiry): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <?php if($inquiry->is_send_to_seller == 1): ?>
            <!-- Modal -->
            <div class="modal fade" id="viewInquirySeller<?php echo e($inquiry->inquiry_id); ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
              <div class="modal-dialog modal-lg modal-dialog-scrollable" role="document">
                <div class="modal-content">
                  <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Inquiry Sellers For <?php echo e((isset($inquiry->product->product_name) ? $inquiry->product->product_name : $inquiry->product_name)); ?></h5>
                  ...
                  <div class="modal-body">
                      <table class="table table-striped table-responsive">
                          ...
                          <tbody>
                             <?php $no = 0; ?>
                             <?php if(count($inquiry->inquiry_sellers) > 0): ?>
                                <?php $__currentLoopData = $inquiry->inquiry_sellers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $inquirySeller): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                      <th scope="row"><?php echo e(++$no); ?></th>
                                      <td><?php echo e($inquirySeller->user->name); ?></td>
                                      <td><?php echo e($inquirySeller->user->company_name); ?></td>
                                      <td><?php echo e($inquirySeller->user->email); ?></td>
                                      <td><?php echo e($inquirySeller->user->mobile); ?></td>
                                    </tr>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                             <?php else: ?>
                                <tr>
...
</html><?php /**PATH /home/ltqh13w2vszk/public_html/resources/views/admin/inquiries.blade.php ENDPATH**/ ?>