          ...
          <div class="row">
            <div class="col-sm-12 col-md-12">
              <div class="main-heading text-center ">
                <p><img src="<?php echo e(asset('public/img/gif/sound.gif')); ?>" style="width:70px;height:70px;" alt="Agriculture"> 24*7 Services</p>
              </div>
            </div>
          </div>
          <div class="row" >
                            ...
                            <div class="pricing-plan hero-bg rounded">
                                ...
                                <div class="plan-desc">
                                    ...
                                    <div class="price-icon">
                                        <img src="<?php echo e(asset('public/img/gif/buy1g1.gif')); ?>" class="latest_package" alt="" width="145px" height="70px">
                                    </div>
                                </div>
                        ...
                        <div class="col-lg-4 col-12">
                            <div class="pricing-plan hero-bg rounded">
                                ...
                                <div class="plan-desc">
                                    ...
                                    <div class="price-icon">
                                        <img src="<?php echo e(asset('public/img/gif/30per3.jpg')); ?>" class="latest_package" width="120px" height="40px" alt="">
                                    </div>
                                </div>
                                <div class="plan-features">
                                    <ul class="list-bordered">
                        ...
                        <div class="col-lg-4 col-12">
                            <div class="pricing-plan hero-bg rounded">
                                ...
                                <div class="plan-desc">
                                    ...
                                    <div class="price-icon">
                                        <img src="<?php echo e(asset('public/img/gif/50per.gif')); ?>" class="latest_package" width="120px" height="40px" alt="">
                                    </div>
                                </div>
                                <div class="plan-features">
                                    <ul class="list-bordered">
...
<?php endif; ?>
  <?php echo $__env->make('header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/a0yq2z3dupoj/public_html/resources/views/latest-package/package.blade.php ENDPATH**/ ?>