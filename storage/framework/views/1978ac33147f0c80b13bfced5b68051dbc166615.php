                            	...
                            	<div class="card text-center">
                            		<div class="thumb-content">
                            		    <?php if(!empty($product->product_image)): ?>
                                            <img class="card-img-top img-fluid" src="<?php echo e(url('/')); ?>/public/storage/product/<?php echo e($product->product_image); ?>">
                                        <?php else: ?>
                                            <img class="card-img-top img-fluid" src="<?php echo e(url('/')); ?>/public/img/no-image.jpg">
                                        <?php endif; ?>
                            		</div>
                            		<div class="card-body">
                            		    <h4 class="card-title"><a href="<?php echo e(URL::to('/product')); ?>/<?php echo e($product->product_slug); ?>"><?php echo e($product->product_name); ?>123</a></h4>
...
<div class="container">
	...
	<div class="col-sm-12 col-md-6 col-lg-2 mb-3 md-none"></div>
	<div class="col-sm-12 col-md-6 col-lg-3 mb-3">
		<div class="shadow vendor">
		<span>
							...
							<div class="product-item">
								<div class="card">
									<div class="thumb-content">
										<a href="#">
											<?php if(!empty($product->product_image)): ?>
                                                <img class="card-img-top" src="<?php echo e(url('/')); ?>/public/storage/product/<?php echo e($product->product_image); ?>">
                                            <?php else: ?>
                                                <img class="card-img-top" src="<?php echo e(url('/')); ?>/public/img/no-image.jpg">
                                            <?php endif; ?>
										</a>
									</div>
									<div class="card-body">
...
<?php echo $__env->make('vendor-themes.theme-1.includes.footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/inforrmz/venicered.com/resources/views/vendor-themes/theme-1/index.blade.php ENDPATH**/ ?>