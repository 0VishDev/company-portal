  ...
  <div class="container ven-dash fltr-ld leads">
      	<div class="bg-red shadow p-2 mb-2">
			<div class="row">
				<div class="col-sm-12">
					<h5 class="text-white">
						You can Shortlist the Leads it might be work for you.
					</h5>
					</div>
			</div>
		</div>
...
<!-- Right Panel -->
<?php echo $__env->make('vendor-dash.bottom-links', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ltqh13w2vszk/public_html/text/resources/views/vendor-dash/shortlisted-leads.blade.php ENDPATH**/ ?>