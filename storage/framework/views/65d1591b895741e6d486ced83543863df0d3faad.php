    ...
    <div class="row">
        <div class="col-md-12">
             ...
             <?php echo e(csrf_field()); ?>
                ...
                <div class="form-group row">
                    <div class="col-sm-6">
                        <label for="site_keywords"><?php echo e(Helper::translation(1930,$translate)); ?> in less than 70 words<span class="required">*</span></label>
                        <textarea name="product_short_desc" id="product_short_desc" rows="12" class="form-control noscroll_textarea" data-bvalidator="required,maxlen[160]" placeholder="Short description of the product within 70 words"><?php echo e($edit['product']->product_short_desc); ?></textarea>
                    </div>
                    <div class="col-sm-6">
                         <label for="site_desc"><?php echo e(Helper::translation(1931,$translate)); ?><span class="required">*</span></label>
                       <textarea name="product_desc" id="summary-ckeditor" rows="3"  class="form-control" data-bvalidator="required"><?php echo e(html_entity_decode($edit['product']->product_desc)); ?></textarea>
                    </div>
                </div>
                <div class="form-group row">
                    <div class="col-sm-6">
                        ...
                        <select name="product_category[]" class="form-control h-150p" data-bvalidator="required" multiple>
                                                ...
                                                <option value="cat-<?php echo e($menu->cat_id); ?>" <?php if(in_array($cats,$product_categories)): ?> selected="selected" <?php endif; ?>><?php echo e($menu->category_name); ?></option>
                                                     ...
                                                     <option value="subcat-<?php echo e($sub_category->subcat_id); ?>" class="ml-2" <?php if(in_array($subcats,$product_categories)): ?> selected="selected" <?php endif; ?>>- <?php echo e($sub_category->subcategory_name); ?></option>
                                                     <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?> 
                                                </select>
                    </div>
                    ...
                    <div class="col-sm-6">
                        ...
                        <input type="file" id="product_gallery[]" name="product_gallery[]" class="form-control-file" data-bvalidator="extension[jpg:png:jpeg]" data-bvalidator-msg="<?php echo e(Helper::translation(1937,$translate)); ?>" multiple><br/><?php $__currentLoopData = $editimage['view']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                     <div class="item-img"><img src="<?php echo e(url('/')); ?>/public/storage/product/<?php echo e($product->product_image); ?>" alt="<?php echo e($product->product_image); ?>" class="item-thumb">
                                                    <a href="<?php echo e(url('/edit-product')); ?>/dropimg/<?php echo e(base64_encode($product->proimg_id)); ?>" onClick="return confirm('<?php echo e(Helper::translation(1968,$translate)); ?>');" class="drop-icon"><span class="fa fa-trash-o drop-icon"></span></a>
                                                    </div>
                                                   <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php endif; ?>
<?php /**PATH /home/inforrmz/venicered.com/resources/views/edit-product.blade.php ENDPATH**/ ?>