      ...
      <ul class="nav navbar-nav">
	    ...
	    <?php if(in_array('vr-trust',$avilable) || Auth::user()->user_type == 'admin'): ?>
	        <li class="<?php echo e(( ( \Request::is('/admin/vr-trust')) ? 'current' : '')); ?>">
	          <a href="<?php echo e(url('/admin/vr-trust')); ?>"> <i class="menu-icon fa fa-list"></i> World Trust</a>
	        </li>
	    <?php endif; ?>
        ...
        <li >
          <a href="<?php echo e(url('/admin/add-coupon')); ?>"> <i class="menu-icon fa fa-list"></i>Add Coupon</a>
        </li>
      </ul>
    </div>
    <!-- /.navbar-collapse -->
...
<input type="hidden" id="base_path" name="base_path" value="<?php echo e(url('/')); ?>"><?php /**PATH /home/a0yq2z3dupoj/public_html/businessworldtrade.in/resources/views/admin/navigation.blade.php ENDPATH**/ ?>