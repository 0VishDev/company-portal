...
<html lang="en">
  ...
  <body>
    ...
    <div class="container mt-3" id="demo">
      <div class="bg-white leads shadow p-5 jplist-panel">
                    ...
                    <div class="col-sm-12 col-md-8">
                      <div class="row">
                        <div class="col-sm-12 col-md-6 col-lg-6 mb-1">
                          <h5><img src="/public/img/lead-flag.png" alt="India" class="country-flag"> <?php echo e((isset($inquiry->product) ? $inquiry->product->product_name : $inquiry->product_name)); ?></h5>
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-6 mb-1">
                          <h5 class="time"><img src="/public/img/lead-watch.png" alt="India" class="country-flag"> 
...
<?php endif; ?><?php /**PATH /home/inforrmz/venicered.com/resources/views/search-leads.blade.php ENDPATH**/ ?>