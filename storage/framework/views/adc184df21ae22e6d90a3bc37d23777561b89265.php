          ...
          <div id="client-logos" class="owl-carousel text-center trending-ads-slide">
            ...
            <div class="item">
              <div class="client-inners">
                <a href="#<?php echo e($category['category_slug']); ?>"><img src="<?php echo e(url('/')); ?>/public/storage/category/<?php echo e($category['category_image']); ?>" alt="<?php echo e($category['category_name']); ?>"> <?php echo e($category['category_name']); ?></a>
              </div>
            </div>
        ...
        <?php $__currentLoopData = $categoryAll; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    		<div class="shadow bg-white pr-3 pl-3 pb-4 mb-3 hub" id="<?php echo e($category['category_slug']); ?>">
              ...
              <div class="col-sm-12 col-md-12 col-lg-12 mb-3">
                <h4 class="black pb-2 mt-2 pt-2 cate-rgn-img"><img src="<?php echo e(url('/')); ?>/public/storage/category/<?php echo e($category['category_image']); ?>" alt="<?php echo e($category['category_name']); ?>"> <?php echo e($category['category_name']); ?></h4>
                </div>
...
<?php endif; ?><?php /**PATH /home/ltqh13w2vszk/public_html/text/resources/views/region.blade.php ENDPATH**/ ?>