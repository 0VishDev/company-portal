...
<body>
        ...
        <div class="container-fluid">
            <div class="header clearfix">
                ...
                <div class="menu-section">
                    <ul>
                        <li>
                            <a href="<?php echo e(url('/')); ?>/venicered-lending/e-filing">Home</a>
                        </li>
						<li>
	...
	<div class="banner-area e-filing">
                <div class="banner-content">
					<h1>E-Filing for all the  <span style="color:#ff1d25;">Manufacturers,</span> Exporter, <span style="color:#ff1d25;">Importer,</span> Traders, <span style="color:#ff1d25;"> Supplier,</span> and Retailer.</span></h1>
    ...
    <div class="benefit-section process-section-main">
        <div class="container-fluid">
            <h3>Venice Red E- filing service includes the following.</h3>
            <ul>
    ...
    <div class="know-more-section">
        <div class="container-fluid">
            <strong>TO KNOW MORE ABOUT VENICERED E-FILING</strong>
            <ul>
                <li>
...
<?php /**PATH /home/ltqh13w2vszk/public_html/text/resources/views/venicered-lending/e-filing.blade.php ENDPATH**/ ?>