                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <?php if($requestFeeback->is_verify == 0): ?>
                                                        <a href="<?php echo e(url('admin/feedback/'.$requestFeeback->id.'/verify')); ?>" class="btn btn-danger" title="Verify"><span class="fa fa-stop-circle-o"></span></a>
                                                    <?php endif; ?>
                                                    <a href="<?php echo e(url('admin/feedback/'.$requestFeeback->id.'/delete')); ?>" title="Delete" class="btn btn-danger" onClick="return confirm('Are you sure you want to delete?');"><span class="fa fa-trash"></span></a>
                                                </td>
                                            </tr> 
...
</html><?php /**PATH /home/ltqh13w2vszk/public_html/text/resources/views/admin/feedback.blade.php ENDPATH**/ ?>