...
<div id="right-panel" class="right-panel">
                    ...
                    <div class="col-sm-6">
                          ...
                          <div class="">
                              ...
                              <select class="form-control" id="category" name="category" required>
                                <?php $__currentLoopData = $subCategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subCategory): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($subCategory->subcat_id); ?>" <?php echo e(($mode == 'edit' ? ($product->product_category == $subCategory->subcat_id ? 'selected' : '') : '')); ?>><?php echo e($subCategory['subcategory_name']); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
							   </select>
                      ...
                      <div class="form-group col-sm-12">
                          <div class="">
                              ...
                              <textarea class="form-control" rows="5" name="product_short_desc" id="product_short_desc" required><?php echo e(($mode == 'edit' ? $product->product_short_desc : '')); ?></textarea>
	...
	<?php echo $__env->make('vendor-dash.bottom-links', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/inforrmz/venicered.com/resources/views/vendor-dash/add-product.blade.php ENDPATH**/ ?>