...
/* selivrate */
 ...
 @keyframes  confetti-fast {
   ...
   100% {
     transform: translate3d(-80px, 150vh, 0) rotateX(10deg) rotateY(250deg);
  }
}
 .container-selibrity {
...
<div class="js-container container-selibrity" style="height:200px;padding-top:80px;">
    <h3 class="text-center">Here Scratch Now And Get Offers</h3>
</div>
...
<div class="container-srcatch" id="js-container">
  ...
  <form class="form" style="visibility: hidden;">
      <br>
    <h2 class="text-center">Better Luck<br> Next  Time</h2>
    <!--<div>
...
<?php echo $__env->make('vendor-dash.bottom-links', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/a0yq2z3dupoj/public_html/resources/views/vendor-dash/scratch-card.blade.php ENDPATH**/ ?>