                                ...
                                <div id="pay-invoice">
                                    <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="file" id="service_image" name="service_image" class="form-control-file" accept="image/*" data-bvalidator="<?php echo e(($mode == 'edit' ? '' : 'required')); ?>" data-bvalidator="extension[jpg:png:jpeg]" data-bvalidator-msg="Please select file of type .jpg, .png or .jpeg"></div>
                                                <?php if($mode == 'edit'): ?>
...
</html><?php /**PATH /home/inforrmz/venicered.com/resources/views/admin/services/form.blade.php ENDPATH**/ ?>