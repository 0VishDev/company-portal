...
<body>
  ...
  <main role="main">
    <div class="container">
      ...
      <?php endif; ?>
      <?php if($shop->product_condition == 'new'){ $badg = "badge badge-warning"; } else { $badg = "badge
      badge-secondary"; } ?>
      <?php if($shop->product_condition != ""): ?><div class="mt-2"><?php echo e(Helper::translation(1950,$translate)); ?> : <span
          class="<?php echo e($badg); ?>"><?php echo e($shop->product_condition); ?></span></div><?php endif; ?>
      ...
      <div class="mt-5"><?php if($shop->product_price != 0): ?><span <?php if($shop->product_offer_price != 0): ?> class="fs16 offer-price
          red-color" <?php else: ?> class="fs32"
          <?php endif; ?>><?php echo e($allsettings->site_currency_symbol); ?><?php echo e($shop->product_price); ?></span><?php endif; ?>
        <?php if($shop->product_offer_price != 0): ?><span
          class="fs32"><?php echo e($allsettings->site_currency_symbol); ?><?php echo e($shop->product_offer_price); ?></span><?php endif; ?></div>
      ...
      <div class="qty mt-5 mb-5">
        ...
        <span>
          ...
          <select name="product_attribute[]" class="form-control qty_box">
      ...
      <div class="mt-2"><?php echo e(Helper::translation(1987,$translate)); ?> : <span><a
            href="<?php echo e(URL::to('/user')); ?>/<?php echo e($seller->username); ?>" class="theme-color"><?php echo e($seller->name); ?></a></span>
      </div>
      <?php if(!is_null($shop->minimum_order_qty)): ?>
      <div class="mt-2">
        <span class="text-danger">Minimum Order: <?php echo e($shop->minimum_order_qty . " " . $shop->minimum_order_unit); ?>

        </span><br>
      </div>
      <?php endif; ?>
      <?php if($shop->product_type != 'digital'): ?><div class="mt-2"><?php echo e(Helper::translation(2094,$translate)); ?> :
        <span><?php echo e($shop->product_estimate_time); ?> <?php echo e(Helper::translation(2071,$translate)); ?></span></div><?php endif; ?>
      <?php if(Auth::guest()): ?>
      <div class="mt-3">
        ...
        <?php endif; ?>
        <a href="<?php echo e(URL::to('/login')); ?>" class="btn button-color float-left">Get Best Price</a>
      </div>
      <?php else: ?>
      ...
      <div class="mt-3">
        ...
        <a class="bla-2 btn btn-danger float-left mr-1" href="<?php echo e($shop->product_video_url); ?>"><i
            class="fa fa-file-video-o"></i> <?php echo e(Helper::translation(2147,$translate)); ?></a>
        <?php endif; ?>
        <button class="btn btn-blue text-white onGetBestPrice" data-target="#GetBestPrice" data-toggle="modal">Get Best
          Price</button>
      ...
      <div class="mt-3">
        ...
        <a class="bla-2 btn btn-danger float-left mr-1" href="<?php echo e($shop->product_video_url); ?>"><i
            class="fa fa-file-video-o"></i> <?php echo e(Helper::translation(2147,$translate)); ?></a>
        <?php endif; ?>
        <a href="<?php echo e($shop->product_external_url); ?>" class="btn button-color float-left"
          target="_blank"><?php echo e(Helper::translation(2148,$translate)); ?></a>
      </div>
      <?php endif; ?>
      <?php else: ?>
      <div class="mt-3">
        ...
        <a class="bla-2 btn btn-danger float-left mr-1" href="<?php echo e($shop->product_video_url); ?>"><i
            class="fa fa-file-video-o"></i> <?php echo e(Helper::translation(2147,$translate)); ?></a>
        <?php endif; ?>
        <a href="<?php echo e(URL::to('/edit-product')); ?>/<?php echo e($shop->product_token); ?>"
          class="btn button-color float-left"><?php echo e(Helper::translation(2149,$translate)); ?></a>
      </div>
      <?php endif; ?>
      <?php endif; ?>
      <?php endif; ?>
      ...
      <input type="hidden" name="price" value="<?php echo e(base64_encode($shop->product_offer_price)); ?>">
      <?php else: ?>
      <input type="hidden" name="price" value="<?php echo e(base64_encode($shop->product_price)); ?>">
      <?php endif; ?>
        ...
        <div class="col-lg-3 col-md-6 col-sm-6 col-xs-6 mb-2 pb-2">
          <div class="product-grid2">
            <div class="product-image2">
              ...
              <ul class="social">
                <?php if(Auth::guest()): ?>
                <li><a href="<?php echo e(url('/login')); ?>" data-tip="<?php echo e(Helper::translation(2066,$translate)); ?>"><i
                      class="fa fa-heart"></i></a></li>
                <?php else: ?>
                <?php if(Auth::user()->id != $product->user_id): ?>
                <li><a href="<?php echo e(url('/wishlist')); ?>/<?php echo e(Auth::user()->id); ?>/<?php echo e($product->product_token); ?>"
                    data-tip="<?php echo e(Helper::translation(2066,$translate)); ?>"><i class="fa fa-heart"></i></a></li>
                <?php endif; ?>
                <?php endif; ?>
              ...
              <div class="col-md-4 con-bg12">
                <div class="contact-info">
                  <div class="text-center">
                    <?php if($shop->product_image != ""): ?>
                    <img class="img img-fluid" src="<?php echo e(url('/')); ?>/public/storage/product/<?php echo e($shop->product_image); ?>" />
                    <?php else: ?>
                    <?php $imagecount = count($shop->productimages); ?>
                    <?php if($imagecount != 0): ?>
                    <img class="img img-fluid"
                      src="<?php echo e(url('/')); ?>/public/storage/product/<?php echo e($shop->productimages[0]->product_image); ?>" />
                    <?php endif; ?>
                    <?php endif; ?>
                    <p><?php echo e($shop->product_name); ?></p>
                    <div class="mt-5"><?php if($shop->product_price != 0): ?><span <?php if($shop->product_offer_price != 0): ?>
                        class="fs16 offer-price red-color" <?php else: ?> class="fs32"
                        <?php endif; ?>><?php echo e($allsettings->site_currency_symbol); ?><?php echo e($shop->product_price); ?></span><?php endif; ?>
                      <?php if($shop->product_offer_price != 0): ?><span
                        class="fs32"><?php echo e($allsettings->site_currency_symbol); ?><?php echo e($shop->product_offer_price); ?></span><?php endif; ?>
                    </div>
                    <span>Sold By - <?php echo e($seller->name); ?></span><br>
                    <?php if(!is_null($shop->minimum_order_qty)): ?>
                    <span class="text-danger">Minimum Order:
...
<?php endif; ?><?php /**PATH /home/inforrmz/b2bkart.inforidgetechnologyindia.com/resources/views/product.blade.php ENDPATH**/ ?>