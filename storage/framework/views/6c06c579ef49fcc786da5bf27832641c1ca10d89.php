      ...
      <div class="container mt-3">
         <div class="row mb-5 pb-5">
          ...
          <div class="card">
            ...
            <img src="<?php echo e(url('/')); ?>/public/storage/post/<?php echo e($post->post_image); ?>" alt="<?php echo e($post->post_title); ?>" class="card-img-top blog-img-lg rounded-0 aos-init aos-animate" data-aos="fade-up-right">
            <?php else: ?>
            ...
            $video_id = $video_id[1];
            ?>
            <iframe type="text/html" width="100%" height="300px" src="https://www.youtube.com/embed/<?php echo e($video_id); ?>?showinfo=0&rel=0&color=white&iv_load_policy=3" frameborder="0" allowfullscreen></iframe> 
            <?php endif; ?>
            <?php
            ...
            <div class="card-body">
              ...
              <p class="card-text"><?php echo str_limit($post->post_short_desc, 500); ?></p>
                ...
                <div class="col-lg-12">
                  <ul class="list-unstyled mb-0">
                    <?php $__currentLoopData = $catData['post']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <li>
                      <a href="<?php echo e(URL::to('/blog')); ?>/category/<?php echo e($post->blog_cat_id); ?>/<?php echo e($post->blog_category_slug); ?>" class="ash-color">
...
<?php endif; ?><?php /**PATH /home/ltqh13w2vszk/public_html/resources/views/blog.blade.php ENDPATH**/ ?>