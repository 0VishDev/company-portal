	...
	<header id="header" class="header">
	 ...
	 <div class="container ven-dash">				 
          ...
          <div class="col-md-4 col-sm-6">
            <ul id="tabsJustified" class="nav nav-tabs nav-justified">
              ...
              <li class="nav-item"><a href="" data-target="#inactiveproduct" data-toggle="tab" class="nav-link small text-uppercase">Inactive <?php echo e(count($inActiveProducts)); ?></a></li>
			   ...
			   <button type="button" class="btn btn-md btn-info float-right"><a href="/vendor/add-product" style="color:#fff;">Add Product</a></button>
			   </div>
			  <div class="col-md-12">
                				  ...
                				  <div class="col-sm-8 col-md-8">
                					...
                					<div class="col-sm-9">
                					  <div class="product-name">
                						<h5><span><?php echo e($product->product_name); ?></span> <br><br><small> <?php echo (is_numeric($product->product_price) ? '₹'.$product->product_price : $product->product_price); ?> / <?php echo e($product->product_unit); ?></small></h5>
                                                                		...
                                                                		<div class="col-md-12 con-bg1">
                                                                			<div class="contact-form">
                                                                				...
                                                                				<div class="form-group row">
                                                                				  ...
                                                                				  <div class="col-sm-9">          
                                                                					<input type="text" name="variants[0][package_type]" value="<?php echo e($variant->package_type); ?>">
                                                                				  </div>
                                                                				</div>
                                                                			</div>
                                                                		</div>
       ...
       <!-- .content -->
        ...
        <!-- Right Panel -->
<?php echo $__env->make('vendor-dash.bottom-links', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/inforrmz/venicered.com/resources/views/vendor-dash/manage-products.blade.php ENDPATH**/ ?>