                                ...
                                <div id="pay-invoice">
                                    <div class="card-body">
                                       <div class="form-group">
                                                ...
                                                <input id="page_title" name="page_title" type="text" class="form-control" value="<?php echo e($edit['page']->page_title); ?>" data-bvalidator="required">
                                            </div>
                                            <div class="form-group">
                                                <label for="site_desc" class="control-label mb-1">Description<span class="require">*</span></label>
                                            <textarea name="page_desc" id="summary-ckeditor" rows="6" placeholder="page description" class="form-control" data-bvalidator="required"><?php echo e(html_entity_decode($edit['page']->page_desc)); ?></textarea>
                                            </div>
                                            <div class="form-group">
...
</html><?php /**PATH /home/a0yq2z3dupoj/public_html/demo/resources/views/admin/edit-page.blade.php ENDPATH**/ ?>