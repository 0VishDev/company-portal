            ...
            <div class="animated fadeIn">
                ...
                <div class="col-md-12">
                    <div class="card">
                           ...
                           <?php else: ?>
                           <form action="<?php echo e(url('/admin/sub-administrator/add')); ?>" method="post" id="setting_form" enctype="multipart/form-data">
                           ...
                           <div class="card-body">
                                ...
                                <div id="pay-invoice">
                                    <div class="card-body">
                            <div class="form-group">
                                    <label for="customer_earnings" class="control-label mb-1"><strong>Permission</strong></label>
                                    <ul class="permis">
                                    <?php $__currentLoopData = $permission['admin']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                     <li class=row>
                                     <span class="col-sm-6 mb-1"><input type="checkbox" id="user_permission[]" name="user_permission[]" value="<?php echo e($key); ?>"> <?php echo e($value); ?></span>
...
</html><?php /**PATH /home/a0yq2z3dupoj/public_html/resources/views/admin/add-sub-administrator.blade.php ENDPATH**/ ?>