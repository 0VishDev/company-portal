...
<title>Business Insurance Contact- <?php echo e($allsettings->site_title); ?></title>
...
<body>
        ...
        <?php endif; ?>
                ...
                <div class="menu-section">
                    <ul>
						...
						<li>
                            <a href="<?php echo e(url('/')); ?>/lending/business-insurance#aboutSection">About Us</a>
                        </li>
                        <li>
	...
	<div class="container">
			<div class="formBox shadow">
				...
				<h5>Business World Trade Pvt. Ltd.</h5>
		...
		<div class="container">
			<div class="formBox shadow">
				<form action="<?php echo e(url('business-inquiry/add')); ?>" method="POST">
				    <?php echo csrf_field(); ?>
				    <input type="hidden" name="type" id="type" value="BUSINESS-INSURANCE">
    ...
    <div class="know-more-section">
        <div class="container-fluid">
            <strong>TO KNOW MORE ABOUT Business World Trade BUSINESS LOAN</strong>
            <ul>
                <li>
...
<?php /**PATH /home/a0yq2z3dupoj/public_html/demo/resources/views/lending/contact-insurance.blade.php ENDPATH**/ ?>