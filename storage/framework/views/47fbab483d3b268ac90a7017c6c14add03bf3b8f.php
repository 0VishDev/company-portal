<?php echo $__env->make('vendor-themes.theme-1.includes.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                            ...
                            <div class="product-item bg-light">
                            	<div class="card text-center">
                            		...
                            		<div class="card-body">
                                        ...
                                        <p class="card-text"><button class="btn btn-show btn-sm" title="<?php echo e($product->product_name); ?>" data-send-inquiry-btn seller="<?php echo e($product->user); ?>" buyer="<?php if(Auth::check()): ?> <?php echo e(Auth::user()); ?> <?php endif; ?>" product="<?php echo e($product); ?>">Send Inquiry</button></p>
                            		</div>
                            	</div>
                            </div>
    					</li>
...
<div class="container">
	     ...
	     <?php $__currentLoopData = $user_details->package_tags; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $packageTag): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        	<div class="col-sm-12 col-md-6 col-lg-3 mb-3">
        	    <div class="shadow vendor">
        		    ...
        		    <span>Services Package<br><span class="ser-d"><?php echo e($packageTag->service_provider->provider_name); ?></span></span>
        		</div>
        	</div>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
      <?php endif; ?>
	...
	<div class="col-sm-12 col-md-6 col-lg-3 mb-3">
		...
		<span>Nature of Business<br><span class="ser-d"><?php echo e($user_details->nature_of_business); ?></span></span>
		</div>
		</div>
	<div class="col-sm-12 col-md-6 col-lg-3 mb-3">
		<div class="shadow vendor">
		...
		<span>Total Number of Employees<br><span class="ser-d"><?php echo e($user_details->no_of_employees); ?></span></span>
		</div>
		</div>
	<div class="col-sm-12 col-md-6 col-lg-3 mb-3">
		<div class="shadow vendor">
		...
		<span>Year of Establishment<br><span class="ser-d"><?php echo e($user_details->year_of_establishment); ?></span></span>
		</div>
		</div>
	<div class="col-sm-12 col-md-6 col-lg-3 mb-3">
		<div class="shadow vendor">
		...
		<span>Legal Status of Firm<br><span class="ser-d"><?php echo e($user_details->legal_status_of_firm); ?></span></span>
		</div>
		</div>
	<div class="col-sm-12 col-md-6 col-lg-3 mb-3">
		<div class="shadow vendor">
		...
		<span>Annual Turnover<br><span class="ser-d"><?php echo e($user_details->annual_turnover); ?></span></span>
		</div>
		</div>
	<div class="col-sm-12 col-md-6 col-lg-3 mb-3">
		<div class="shadow vendor">
		...
		<span>GST Number<br><span class="ser-d"><?php echo e($user_details->gst_no); ?></span></span>
		</div>
		</div>
		<div class="col-sm-12 col-md-6 col-lg-3 mb-3">
		<div class="shadow vendor">
		...
		<span>PAN Number<br><span class="ser-d"><?php echo e($user_details->pan_no); ?></span></span>
		</div>
		</div>
		</div>
	</div>
		...
		<div class="row">
			...
			<div class="col-md-12">
				<div class="product-grid-list">
					<div class="row mt-30">
						<?php $__currentLoopData = $shop['product']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
						<div class="col-sm-12 col-lg-3 col-md-6 mb-3" style="<?php echo e(($key > 7 ? 'display:none;' : '')); ?>" <?php echo e(($key > 7 ? 'data-product-list' : '')); ?>>
							<!-- product card -->
								...
								<div class="card">
									<div class="thumb-content">
										<a href="<?php echo e(URL::to('/product')); ?>/<?php echo e($product->product_slug); ?>" title="<?php echo e($product->product_name); ?>">
											<?php if(!empty($product->product_image)): ?>
                                                <img class="card-img-top1" src="<?php echo e(url('/')); ?>/public/storage/product/<?php echo e($product->product_image); ?>" alt="<?php echo e($product->product_name); ?>">
                                            <?php else: ?>
                                                <img class="card-img-top1" src="<?php echo e(url('/')); ?>/public/img/no-image.jpg" alt="<?php echo e($product->product_name); ?>">
                                            <?php endif; ?>
										</a>
									</div>
									<div class="card-body">
...
<?php echo $__env->make('vendor-themes.theme-1.includes.footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/a0yq2z3dupoj/public_html/demo/resources/views/vendor-themes/theme-1/index.blade.php ENDPATH**/ ?>