                                    ...
                                    <div class="card-body row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text"  id="service_price" name="service_price" class="form-control" value="<?php echo e(($mode == 'edit' ? $serviceProvider->service_price : '')); ?>">
                                            <?php if($errors->has('service_price')): ?>
                                                ...
                                                <input type="text"  id="total_lead" name="total_lead" class="form-control" value="<?php echo e(($mode == 'edit' ? $serviceProvider->total_lead : '')); ?>">
                                            <?php if($errors->has('total_lead')): ?>
                                                  <span class="help-block text-danger">
                                                    <strong><?php echo e($errors->first('total_lead')); ?></strong>
                                                  </span>
                                                <?php endif; ?>                                       
                                                </div>
                                         </div>
...
</html><?php /**PATH /home/a0yq2z3dupoj/public_html/resources/views/admin/service-providers/form.blade.php ENDPATH**/ ?>