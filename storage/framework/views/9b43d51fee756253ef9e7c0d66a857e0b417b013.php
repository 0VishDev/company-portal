...
<html lang="en">
<head>
<title><?php echo e(Helper::translation(2053,$translate)); ?> - <?php echo e($allsettings->site_title); ?></title>
...
<?php echo $__env->make('header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <section class="headerbg" style="background-image: url('<?php echo e(url('/')); ?>/public/storage/settings/<?php echo e($allsettings->site_header_background); ?>');">
      <div class="container text-left">
        <h2 class="mb-0"><?php echo e(Helper::translation(2053,$translate)); ?></h2>
        <p class="mb-0"><a href="<?php echo e(URL::to('/')); ?>"><?php echo e(Helper::translation(1913,$translate)); ?></a> <span class="split">&gt;</span> <span><?php echo e(Helper::translation(2053,$translate)); ?></span></p>
      </div>
    </section>
  <main role="main">
           ...
           <div class="col-md-12 mt-1 mb-1 pt-1 pb-1">
                  ...
                  <div class="row list" align="center">
                           <?php $z = 1; ?>
                              <?php $__currentLoopData = $shop['product']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> 
                               ...
                               <span class="remove"><a href="<?php echo e(url('/wishlist')); ?>/<?php echo e(base64_encode($product->wid)); ?>" class="quickview" onClick="return confirm('<?php echo e(Helper::translation(1968,$translate)); ?>');"><i class="fa fa-remove"></i>
                               <p><?php echo e(Helper::translation(2848,$translate)); ?></p></a></span>
            ...
            <?php if($product->product_condition != ""): ?><div class="mt-2"><?php echo e(Helper::translation(1950,$translate)); ?> : <span class="<?php echo e($badg); ?>"><?php echo e($product->product_condition); ?></span></div><?php endif; ?>
                ...
                <div class="mt-1 mb-1 pt-1 pb-1 text-center">
                  <div align="center">
                  <?php echo e(Helper::translation(2204,$translate)); ?>
...
<?php endif; ?><?php /**PATH /home/inforrmz/venicered.com/resources/views/wishlist.blade.php ENDPATH**/ ?>