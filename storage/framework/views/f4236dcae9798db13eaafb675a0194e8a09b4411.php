                   ...
                   <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Seller Contact Inquiry</strong>
                            </div>
                            <div class="card-body">
                                <table class="table table-striped table-bordered table-responsive" id="sellerContactTable">
                                    ...
                                    <tbody>
                                        <?php $no = 0; ?>
                                        <?php $__currentLoopData = $sellerInquiry; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $inquiry): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                            <td><?php echo e(++$no); ?></td>
                                                <td><?php echo e($inquiry->user->company_name); ?></td>
                                                ...
                                                <td>
                                                    ...
                                                    <?php if($inquiry->is_verify == 0): ?>
                                                        <a href="<?php echo e(url('admin/seller-contact/'.$inquiry->id.'/verify')); ?>" class="btn btn-danger mb-1" title="Verify"><span class="fa fa-stop-circle-o"></span></a>
                                                    <?php endif; ?>
                                                    <a href="<?php echo e(url('admin/seller-contact/'.$inquiry->id.'/delete')); ?>" title="Delete" class="btn btn-danger mb-1" onClick="return confirm('Are you sure you want to delete?');"><span class="fa fa-trash"></span></a>
                                                </td>
                                            </tr> 
      ...
      <div class="modal-dialog modal-sm modal-dialog-centered " role="document">
        <div class="modal-content">
          <div class="modal-header">
           ...
           <form action="<?php echo e(url('admin/seller-contact/comment/add')); ?>" method="POST" enctype="multipart/form-data">
               <?php echo csrf_field(); ?>
...
</html><?php /**PATH /home/a0yq2z3dupoj/public_html/resources/views/admin/seller-contact.blade.php ENDPATH**/ ?>