                                    ...
                                    <div class="card-body">
                                       <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="hidden" name="save_subcategory_image" value="<?php echo e($edit['subcategory']->subcategory_image); ?>">
                                            </div>
                                            <!--<div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input id="seo_title" name="seo_title" type="text" class="form-control" value="<?php echo e($edit['subcategory']->seo_title); ?>">
                                            </div>
                                            <div class="form-group">
                                                <label for="site_title" class="control-label mb-1"> SEO Keywords</label>
                                                <textarea name="seo_keywords" id="seo_keywords" class="form-control"><?php echo e($edit['subcategory']->seo_keywords); ?></textarea>
                                            </div>
                                            
                                            <div class="form-group">
                                                <label for="site_title" class="control-label mb-1"> SEO Meta Description</label>
                                                <textarea name="seo_meta_description" id="seo_meta_description" class="form-control"><?php echo e($edit['subcategory']->seo_meta_description); ?></textarea>
                                            </div>
...
</html><?php /**PATH /home/ltqh13w2vszk/public_html/resources/views/admin/edit-subcategory.blade.php ENDPATH**/ ?>