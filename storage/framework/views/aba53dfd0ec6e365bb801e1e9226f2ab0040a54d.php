              ...
              <form method="POST" action="<?php echo e(route('register')); ?>" id="login_form">
               ...
               <div  class="lgn-body">
                   ...
                   <div class="formBox">
                       ...
                       <input type="hidden" id="provider_id" name="provider_id" value="<?php echo e(\Request::query('provider_id')); ?>">
                       <input type="hidden" id="provider" name="provider" value="<?php echo e(\Request::query('provider')); ?>">
                       
						<div class="row">
							<div class="col-sm-6">
								<div class="inputBox focus">
									<div class="inputText">Your Name</div>
									<input id="name" type="text" class="form-control rounded-0 input" name="name" value="<?php echo e(\Request::query('name')); ?>" data-bvalidator="required" autocomplete="name">
...
if (isset($messageCache)) { $message = $messageCache; }
                            ...
                            <div class="col-sm-6">
								<div class="inputBox focus">
									...
									<input id="email" type="email" class="form-control rounded-0 input" name="email" value="<?php echo e(\Request::query('email')); ?>" autocomplete="email" data-bvalidator="email,required">
...
.lgn-body{
    background-image: url(<?php echo e(url('/')); ?>/public/img/login-bg.png);
    background-size: cover;
    background-position: right;
    padding: 56px 122px;
}
.bg-lgn{
    background-image: url(<?php echo e(url('/')); ?>/public/img/crt-usr.jpg);
    background-size: cover;
...
<?php endif; ?><?php /**PATH /home/a0yq2z3dupoj/public_html/demo/resources/views/auth/register.blade.php ENDPATH**/ ?>