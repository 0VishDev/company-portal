			...
			<div id="main-menu" class="main-menu collapse navbar-collapse">
				<ul class="nav navbar-nav">
					...
					<li class="<?php echo e(( ( \Request::is('vendor/lead-desk')) ? 'current' : '')); ?>">
						<a href="<?php echo e(url('/')); ?>/vendor/lead-desk"> <i class="menu-icon fa fa-envelope"></i>Lead Desk</a>
					</li>
...
<div id="right-panel" class="right-panel">
    ...
    </header><?php /**PATH /home/ltqh13w2vszk/public_html/text/resources/views/vendor-dash/left-panel.blade.php ENDPATH**/ ?>