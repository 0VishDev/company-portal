                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php if(!empty($serviceProvider->provider_small_image)): ?> 
                                                  <img height="50" src="<?php echo e(url('/')); ?>/public/storage/service-providers/<?php echo e($serviceProvider->provider_small_image); ?>" alt="<?php echo e($serviceProvider->provider_small_image); ?>" />
                                               <?php else: ?> 
                                                  <img height="50" src="<?php echo e(url('/')); ?>/public/img/no-image.jpg" alt="<?php echo e($serviceProvider->provider_small_image); ?>" />  
                                               <?php endif; ?>
                                            </td>
                                            <td>
...
</html><?php /**PATH /home/ltqh13w2vszk/public_html/text/resources/views/admin/service-providers/list.blade.php ENDPATH**/ ?>