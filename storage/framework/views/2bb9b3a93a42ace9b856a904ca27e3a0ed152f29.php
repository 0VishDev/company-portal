                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <table class="table table-striped table-bordered table-responsive" id="businessContactTable">
                                    ...
                                    <tbody>
                                        <?php $no = 0; ?>
                                        <?php $__currentLoopData = $businessInquiry; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $inquiry): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                <td><?php echo e(++$no); ?></td>
                                                ...
                                                <td>
                                                    <button class="btn btn-danger" title="Add Comment" data-comment-add inquiry-id="<?php echo e($inquiry->id); ?>" comment="<?php echo e($inquiry->comment); ?>"><span class="fa fa-commenting-o"></span></button>
                                                    <?php if($inquiry->is_verify == 0): ?>
                                                        <a href="<?php echo e(url('admin/business-contact/'.$inquiry->id.'/verify')); ?>" class="btn btn-danger" title="Verify"><span class="fa fa-stop-circle-o"></span></a>
                                                    <?php endif; ?>
                                                    <a href="<?php echo e(url('admin/business-contact/'.$inquiry->id.'/delete')); ?>" title="Delete" class="btn btn-danger" onClick="return confirm('Are you sure you want to delete?');"><span class="fa fa-trash"></span></a>
                                                </td>
                                            </tr> 
      ...
      <div class="modal-dialog modal-sm modal-dialog-centered " role="document">
        <div class="modal-content">
          <div class="modal-header">
           ...
           <form action="<?php echo e(url('admin/business-contact/comment/add')); ?>" method="POST" enctype="multipart/form-data">
               <?php echo csrf_field(); ?>
...
</html><?php /**PATH /home/ltqh13w2vszk/public_html/resources/views/admin/business-contact.blade.php ENDPATH**/ ?>