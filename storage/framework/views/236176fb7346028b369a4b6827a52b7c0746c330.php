<header id="header">
  <div class="container-fluid">
    <div class="row">
      ...
      <!--  -->
      <!--</div>-->
      <div class="col-lg-10 col-md-10 col-sm-4 mt-4">
        <nav class="pull-right" id="nav-menu-container">
          <ul class="nav-menu">
            ...
            <?php endif; ?>
            <?php if(Auth::guest()): ?>
            <li><a href="<?php echo e(url('/login')); ?>" class="btn"><?php echo e(Helper::translation(2041,$translate)); ?></a></li>
            <?php else: ?>
            <li class="menu-has-children"><a href="javascript:void(0)"><?php echo e(Helper::translation(2042,$translate)); ?></a>
              <ul>
                ...
                <li><a href="<?php echo e(url('/my-notifications')); ?>">My Notifications</a>
            </li>
  ...
  <div class="navbar navbar-expand-lg category-bar row">
    <div class="container-fluid">
      <div class="col-lg-2 col-md-12 col-sm-12">
        ...
        <!--  <i class="fa fa-bars"></i>-->
        <!--</button>-->
        <button class="btn button-color d-inline-block d-lg-none ml-auto mmiddle pull-right" type="button"
      ...
      <div class="col-lg-2 col-md-12 col-sm-12">
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="nav navbar-nav ml-auto">
            ...
            <li class="nav-item">
              <a class="nav-link" href="<?php echo e(url('/wishlist')); ?>"><i class="fa fa-heart-o" aria-hidden="true" style="color: #ff0000;"></i> <?php echo e(Helper::translation(2053,$translate)); ?></a>
            </li>
...
</header><?php /**PATH /home/inforrmz/b2bkart.inforidgetechnologyindia.com/resources/views/header.blade.php ENDPATH**/ ?>