...
<!-- Right Panel -->
    <?php if(in_array('state',$avilable)): ?>
            ...
            <div class="animated fadeIn">
                <div class="row">
                  <div class="col-md-12">
                       ...
                       <?php else: ?>
                       <form action="<?php echo e(route('admin.add-state')); ?>" method="post" enctype="multipart/form-data">
                                ...
                                <div id="pay-invoice">
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input id="state_name" name="state_name" type="text" class="form-control" required>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <label for="show_in_home"><input type="checkbox" name="show_in_home" id="show_in_home"> Show in Home</label>
                                        </div>
                                    </div>
                                </div>
                             </div>
...
</html><?php /**PATH /home/inforrmz/venicered.com/resources/views/admin/add-state.blade.php ENDPATH**/ ?>