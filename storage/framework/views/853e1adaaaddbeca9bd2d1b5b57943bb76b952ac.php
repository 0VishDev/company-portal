                                ...
                                <div id="pay-invoice">
                                    <div class="card-body">
                                         <div class="form-group">
                                                ...
                                                <input id="pinterest_url" name="pinterest_url" type="text" class="form-control noscroll_textarea" value="<?php echo e($setting['setting']->pinterest_url); ?>" data-bvalidator="url"></div><div class="form-group"><label for="site_title" class="control-label mb-1">Instagram Url </label>
...
</html><?php /**PATH /home/inforrmz/b2bkart.inforidgetechnologyindia.com/resources/views/admin/social-settings.blade.php ENDPATH**/ ?>