                                    ...
                                    <div class="card-body">
                                       <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input id="username" name="mobile" type="number" class="form-control" value="<?php echo e($edit['userdata']->user_phone); ?>" data-bvalidator="required">
                                            </div>
                                                ...
                                                <div class="form-group">
                                                        ...
                                                        <select class="form-control" id="city" name="city" data-bvalidator="required">
                                                            <?php $__currentLoopData = $cities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $city): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <option value="<?php echo e($city->id); ?>" <?php echo e(($edit['userdata']->city_id == $city->id ? 'selected' : '')); ?>><?php echo e($city->city_name); ?></option>
                                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                        </select>
                                                 </div>
                                                <div class="form-group">
                                                    <label for="theme">Theme <span class="require">*</span></label><br>
                                                    <label for="theme_1"><input type="radio" name="theme" value="theme-1" id="theme_1" <?php echo e(($edit['userdata']->vendor_theme == 'theme-1' ? 'checked' : '')); ?>> Theme 1</label>
                                                    <label for="theme_2"><input type="radio" name="theme" value="theme-2" id="theme_2" <?php echo e(($edit['userdata']->vendor_theme == 'theme-2' ? 'checked' : '')); ?>> Theme 2</label>
                                                    <label for="theme_3"><input type="radio" name="theme" value="theme-3" id="theme_3" <?php echo e(($edit['userdata']->vendor_theme == 'theme-3' ? 'checked' : '')); ?>> Theme 3</label>
                                                    <label for="theme_4"><input type="radio" name="theme" value="theme-4" id="theme_4" <?php echo e(($edit['userdata']->vendor_theme == 'theme-4' ? 'checked' : '')); ?>> Theme 4</label>
                                                </div>
                                                ...
                                                <?php if($edit['userdata']->company_logo != ''): ?>
                                                <img width="100" src="<?php echo e(url('/')); ?>/public/storage/company-logo/<?php echo e($edit['userdata']->company_logo); ?>"  class="userphoto"/>
                                                <?php else: ?> 
                                                <img width="100" src="<?php echo e(url('/')); ?>/public/img/no-user.png"  class="userphoto"/>  <?php endif; ?>
...
</html><?php /**PATH /home/a0yq2z3dupoj/public_html/demo/resources/views/admin/edit-vendor.blade.php ENDPATH**/ ?>