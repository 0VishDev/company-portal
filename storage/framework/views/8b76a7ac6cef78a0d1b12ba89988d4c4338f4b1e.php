      ...
      <div class="shadow bg-white hub p-3">
        <div class="row">
          ...
          <div class="col-sm-6 col-md-3 col-lg-2 mb-4">
            <h6><a href="<?php echo e(url('regions/'.$state->id)); ?>"><?php echo e($state->state_name); ?></a></h6>
            <?php $__currentLoopData = $state->cities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $city): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php if($key > 4){ break; } ?>
                <p><a href="<?php echo e(url('city/'.$city->id)); ?>"><?php echo e($city->city_name); ?></a></p>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            
            <?php if(count($state->cities) > 5): ?>
                <p><a href="<?php echo e(url('regions/'.$state->id)); ?>"><u>View More</u></a></p>
            <?php endif; ?>
          </div>
          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
...
<?php endif; ?><?php /**PATH /home/inforrmz/venicered.com/resources/views/locations.blade.php ENDPATH**/ ?>