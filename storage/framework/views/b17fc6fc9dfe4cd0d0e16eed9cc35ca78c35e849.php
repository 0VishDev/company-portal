		        ...
		        <div class="card-body">
		             <form action="<?php echo e(route('contact')); ?>" class="setting_form" id="contact_form" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-row">
                          ...
                          <div class="form-row">
                            <div class="form-group col-md-6">
                              <input id="from_phone" name="from_phone" placeholder="Mobile No." class="form-control" type="number">
                            </div>
                            <div class="form-group col-md-6">
                              <input type="text" name="from_location" class="form-control" id="location" placeholder="Location">
                            </div>
                          </div>
                        <div class="form-row">
                          <div class="form-group col-md-12">
                           <textarea class="form-control" cols="20" rows="5" placeholder="Tell Us Your Requirement" name="message_text" data-bvalidator="required"></textarea>
                            </div>
                        </div>
                        <div class="form-row">
...
<?php endif; ?><?php /**PATH /home/ltqh13w2vszk/public_html/text/resources/views/contact.blade.php ENDPATH**/ ?>