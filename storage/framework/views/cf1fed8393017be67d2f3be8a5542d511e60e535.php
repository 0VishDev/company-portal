                ...
                <div class="row">
                    <div class="col-md-12">
                      <div class="card">
                           ...
                           <?php else: ?>
                           <form action="<?php echo e(route('admin.media-settings')); ?>" method="post" id="setting_form" enctype="multipart/form-data">
                            ...
                            <div class="col-md-6">
                             <div class="card-body">
                                ...
                                <div id="pay-invoice">
                                    <div class="card-body">
                                      <div class="form-group">
                                                <label for="site_title" class="control-label mb-1">Maximum Upload Zip File Size (KB)<span class="require">*</span></label>
                                                <input id="site_max_zip_size" name="site_max_zip_size" type="text" class="form-control noscroll_textarea" value="<?php echo e($setting['setting']->site_max_zip_size); ?>" data-bvalidator="required,digit,min[1]"> <small>Example : 1000</small>
                                            </div>
                                       </div>
                                </div>
                               </div>
                                    ...
                                    <div class="card-body">
                                       <div class="form-group">
                                        ...
                                        <div class="form-group">
                                                ...
                                                <input id="aws_bucket" name="aws_bucket" type="text" class="form-control noscroll_textarea" value="<?php echo e($setting['setting']->aws_bucket); ?>"> <small>Example : yourbucketname</small></div></div>
                                </div>
                             </div>
                            </div>
...
</html><?php /**PATH /home/inforrmz/b2bkart.inforidgetechnologyindia.com/resources/views/admin/media-settings.blade.php ENDPATH**/ ?>