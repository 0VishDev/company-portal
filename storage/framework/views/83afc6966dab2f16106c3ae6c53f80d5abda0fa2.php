...
<link rel="shortcut icon" href="<?php echo e(url('/')); ?>/public/storage/settings/1594989826.png">
        ...
        <div class="container">
                ...
                <div class="menu-section">
                    <ul>
                        ...
                        <li class="contact-number">
                            <a href="tel:77038 66612">77038 66612</a>
                        </li>
                    </ul>
				</div>
            </div>
            <div class="banner-area">
                <div class="banner-content">
                    ...
                    <p>We offer a VR logistics service to fulfill your organization's essentials. By adopting our logistic service, you can spend more time on your loving business. </p>
    ...
    <div class="process-section-main" id="processSection">
        <div class="container-fluid">
            ...
            <div class="process-list">
                ...
                <div class="process">
                    <div class="img-section">
                        <img src="<?php echo e(url('/')); ?>/resources/views/template/logistics/img/icon6.png" alt="Venice Red Process">
                    </div>
                    <div class="content">
    ...
    <div class="modal-dialog modal-lg modal-dialog-centered " role="document">
        <div class="modal-content">
            <div class="modal-header bg-red">
                <h3 class="mb-0">VR logistics Form</h3>
...
<?php /**PATH /home/ltqh13w2vszk/public_html/text/resources/views/logistics/index.blade.php ENDPATH**/ ?>