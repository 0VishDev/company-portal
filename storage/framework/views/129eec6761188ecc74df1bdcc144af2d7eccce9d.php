        ...
        <div class="col-md-12">
         ...
         <div class="card mb-5 shadow-sm bg-white border-0 rounded-0 li-item">
           ...
           <?php if($edit['post']->post_image!=''): ?>
            <img src="<?php echo e(url('/')); ?>/public/storage/post/<?php echo e($edit['post']->post_image); ?>" alt="<?php echo e($edit['post']->post_title); ?>" class="card-img-top blog-img-lg12 rounded-0">
            <?php else: ?>
            ...
            <div class="card-body">
              ...
              <div class="single-blog-content">
                ...
                <?php $__currentLoopData = $postSteps; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $postStep): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php $no = $no + 1; ?>
                    <div class="row midcon <?php echo e((($no % 2)? '': 'direction')); ?>">
                        <div class="col-lg-7">
                            <p><span style="font-weight:bold"><?php echo e($no); ?> - <?php echo e($postStep->step_name); ?></span>-<?php echo e($postStep->step_description); ?></p>
                        </div>
                        <div class="col-lg-4">
                            <?php if(!empty($postStep->step_image)): ?> 
                              <img src="<?php echo e(url('/')); ?>/public/storage/post-steps/<?php echo e($postStep->step_image); ?>" class="w-100" alt="<?php echo e($postStep->step_name); ?>" />
                           <?php else: ?> 
                              <img src="<?php echo e(url('/')); ?>/public/img/no-image.jpg" class="w-100" alt="<?php echo e($postStep->step_name); ?>" />  
                           <?php endif; ?>
                        </div>
                  </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="col-lg-12">
                  <ul class="list-unstyled mb-0">
                    <?php $__currentLoopData = $catData['post']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <li><a href="<?php echo e(URL::to('/blog')); ?>/category/<?php echo e($post->blog_cat_id); ?>/<?php echo e($post->blog_category_slug); ?>" class="ash-color">
                           <span class="fa fa-angle-right"></span> <?php echo e($post->blog_category_name); ?>

                           <span class="post-count">[<?php echo e($category_count->has($post->blog_cat_id) ? count($category_count[$post->blog_cat_id]) : 0); ?>]</span>
                          </a>
                      </li>
                   <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>  
                  </ul>
...
<?php endif; ?><?php /**PATH /home/ltqh13w2vszk/public_html/text/resources/views/single.blade.php ENDPATH**/ ?>