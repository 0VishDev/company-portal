    ...
    <div class="container">
                <div class="row">
                    <div class="col-md-12 register-left">
                        <img src="https://www.venicered.com/text/public/storage/settings/160439769811.png" alt=""/>
                    </div>
                    <div class="col-md-12 mb-3">
                    <div class="top-heading">
                        <h1>VR Payment Sheet</h1>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <form action="#" method="POST" enctype="multipart/form-data" id="paymentsheet">
                            <?php echo csrf_field(); ?>
                                ...
                                <div class="row register-form">
                                    ...
                                    <div class="col-sm-6 form-group mb-3">
                                        ...
                                        <div class="col-sm-12 form-group mb-3">
                                            <table id="payment-list" class="table table-striped payment-list">
                                            <thead>
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>1</td>
                                                    <td>
                                                        <input type="date" class="form-control" name="payment[1][sale_date]">
                                                    </td>
                                                    <td>
                                                        <input type="text" class="form-control" name="payment[1][received_amount]" value="">
                                                    </td>
                                                    <td>
                                                        <input type="text" class="form-control" name="payment[1][balance_amount]" value="">
                                                    </td>
                                                    <td>
                                                    <select class="form-control" id="mode_Of_payment" name="payment[1][mode_Of_payment]">
                                                        <option value=""></option>
                                                    ...
                                                    <td>
                                                        <input type="text" class="form-control" name="payment[1][transaction_no]">
                                                    </td>
                                                    <td>
                                                        <div class="fileUpload">
                                                            <input type="file" class="upload"  name="payment[1][attachment]"/><span>Upload Slip</span></div>
                                                    </td>
                                                </tr>
                                            </tbody>
                                            <tfoot>
                                        ...
                                        <div class="col-sm-6 form-group mb-3">
                                            ...
                                            <option value="Dimond-Package">Dimond Package</option>
                                            <option value="Standard-Package">Standard Package</option>
                                            <option value="Platinum-Package">Platinum Package</option>
                                            <option value="Premium-Package">Premium Package</option>
                                            <option value="Sapphire-Package">Sapphire Package</option>
                                            <option value="Star-Package">Star Package</option>
                                        </select>
        ...
        <div class="row">
        <div class="col-sm-12">
            <h2>Venice Red India PVT. LTD.</h2>
            <p>C-125, Ground Floor, Sector-2, Near Noida Sector-15 Metro Station, Noida, 201301</p>
            </div>
        </div>
            </div>
            </div>
...
</html><?php /**PATH /home/ltqh13w2vszk/public_html/resources/views/paymentsheet.blade.php ENDPATH**/ ?>