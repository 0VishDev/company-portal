         ...
         <div class="content mt-3">
            <div class="animated fadeIn">
                <div class="row">
                   <div class="col-md-12">
                      <div class="card">
                           <form action="<?php echo e(url('/admin/sub-administrator/'.$edit['userdata']->id.'/update')); ?>" method="post" id="setting_form" enctype="multipart/form-data">
                                              ...
                                              <input type="hidden" name="user_type" value="sub-admin">
                                               <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                                    ...
                                                                    <input type="file" id="user_photo" name="user_photo" class="form-control-file" data-bvalidator="extension[jpg:png:jpeg]" data-bvalidator-msg="Please select file of type .jpg, .png or .jpeg"><?php if($edit['userdata']->user_photo != ''): ?>
                             ...
                             <div class="card-body">
                                ...
                                <div id="pay-invoice">
                                  ...
                                  <div class="form-group">
                                    ...
                                    <?php $__currentLoopData = $permission['admin']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                     <li class=row>
                                     <span class="col-sm-6 mb-1"><input type="checkbox" id="user_permission[]" name="user_permission[]" value="<?php echo e($key); ?>" <?php if(in_array($key,$edituser)): ?> checked <?php endif; ?>> <?php echo e($value); ?></span><br/>
                                     <span class="col-sm-3 mb-1"><input type="checkbox" id="user_permission[]" name="view[]" value=""> View</span>
                                     <span class="col-sm-3 mb-1"><input type="checkbox" id="user_permission[]" name="edit[]" value=""> edit</span>
                                     </li>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </ul>
                                  </div>
...
</html><?php /**PATH /home/a0yq2z3dupoj/public_html/resources/views/admin/edit-sub-administrator.blade.php ENDPATH**/ ?>