                        ...
                        <form action="<?php echo e(url('b2b-profile/detail/add')); ?>" method="POST" enctype="multipart/form-data" id="b2bProfileForm">
                            ...
                            <div class="register-right mb-3">
                                <div class="row register-form">
                                    ...
                                    <div class="col-sm-6 form-group mb-3">
                                            <label>Package Name(Offered By Venicered.com)</label>
...
</html><?php /**PATH /home/ltqh13w2vszk/public_html/text/resources/views/profilesheet/b2b.blade.php ENDPATH**/ ?>