  ...
  <div class="container ven-dash">
    <div class="row">
      <div class="col-sm-12 text-center mb-3">
        <h5 class="pb-2">Trusted Seller</h5>
        <h6>Become a trusted seller and get <b>✓ Higher secure Listing on VeniceRed</b> <b>✓ More  Verified Buyer Enquiries</b> <b>✓ Preferred Number Service</b></h6>
      </div>
    </div>
...
<?php echo $__env->make('vendor-dash.bottom-links', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/inforrmz/venicered.com/resources/views/vendor-dash/index.blade.php ENDPATH**/ ?>