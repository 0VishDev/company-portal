...
<link rel="stylesheet" type="text/css" href="{{ url('/') }}/resources/views/template/logistics/css/style.css">
<link href="https://fonts.googleapis.com/css?family=Roboto:300,400,500,700" rel="stylesheet">
<script src="{{ url('/') }}/resources/views/template/logistics/css/jquery.min.js"></script>
<title>Logistics- {{ $allsettings->site_title }}</title>
...
<body>
        ...
        @endif
            ...
            <div class="banner-area">
                <div class="banner-content">
                    ...
                    <p>We offer a Infobiz world trade logistics service to fulfill your organization's essentials. By adopting our logistic service, you can spend more time on your loving business. </p>
                    <div class="btn-section">
                        <a href="#" data-target="#logistic" data-toggle="modal">Get an instant online quote</a>
                    </div>
                </div>
                <div class="banner-image">
                    <img src="{{ url('/') }}/resources/views/template/logistics/img/20450.jpg" alt="Infobiz world trade">
                </div>
            </div>
            ...
            <div class="process-list">
                <div class="process">
                    <div class="img-section">
                        <img src="{{ url('/') }}/resources/views/template/logistics/img/icon1.png" alt="Infobiz world trade Process">
                    </div>
                    <div class="content">
                ...
                <div class="process">
                    <div class="img-section">
                        <img src="{{ url('/') }}/resources/views/template/logistics/img/icon2.png" alt="Infobiz world trade Process">
                    </div>
                    <div class="content">
                ...
                <div class="process">
                    <div class="img-section">
                        <img src="{{ url('/') }}/resources/views/template/logistics/img/icon3.png" alt="Infobiz world trade Process">
                    </div>
                    <div class="content">
                ...
                <div class="process">
                    <div class="img-section">
                        <img src="{{ url('/') }}/resources/views/template/logistics/img/icon4.png" alt="Infobiz world trade Process">
                    </div>
                    <div class="content">
                ...
                <div class="process">
                    <div class="img-section">
                        <img src="{{ url('/') }}/resources/views/template/logistics/img/icon5.png" alt="Infobiz world trade Process">
                    </div>
                    <div class="content">
                ...
                <div class="process">
                    <div class="img-section">
                        <img src="{{ url('/') }}/resources/views/template/logistics/img/icon6.png" alt="Infobiz world trade Process">
                    </div>
                    <div class="content">
    ...
    <div class="know-more-section">
        <div class="container">
            <strong>To Know more about Infobiz world trade Logistics</strong>
            <ul>
                <li>
                    <a href="tel:{{ $allsettings->office_phone }}">{{ $allsettings->office_phone }}</a>
                </li>
    ...
    <div class="modal-dialog modal-lg modal-dialog-centered " role="document">
        <div class="modal-content">
            <div class="modal-header bg-red">
                <h3 class="mb-0">Infobiz world trade logistics Form</h3>
            	...
            	<div class="row">
            		<div class="col-md-12 con-bg1">
            			<div class="contact-form">
            				<form action="{{ url('logistics/add') }}" method="POST" enctype="multipart/form-data" id="logisticsForm">
            				    @csrf
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
            	<div class="row">
            		<div class="col-md-12 con-bg1">
            			<div class="contact-form">
            				<form action="{{ url('logistics/user-detail/add') }}" method="POST" enctype="multipart/form-data" id="userDetailForm">
            				    @csrf
