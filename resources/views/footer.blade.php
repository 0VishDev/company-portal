    ...
    <div class="top">
      <div class="logo-details">
        ...
        <span class="logo_name">
            <img src="{{ asset('public/img/new-img/svg-logo.png') }}" class="img-fluid" type="image/svg+xml" width="285px" height="55px">
    ...
    <div class="link-boxes">
      <ul class="box">
        ...
        <ul class="list-unstyled">
			...
			<li> <a href="{{ URL::to('/page/') }}/{{ $pages->page_slug }}"> {{ ucfirst($pages->page_title) }} </a></li>
			@endforeach
      ...
      <ul class="list-unstyled box">
          <li class="link_name">Our Services</li>
		    <li> <a href="{{ URL::to('/advertise-us') }}">Advertise with Us </a></li>
			<li> <a href="{{ URL::to('/lending/business-loan') }}" target="_blank"> Business Loan</a></li>
            <li> <a href="{{ URL::to('/lending/business-insurance') }}" target="_blank"> Business Insurance </a></li>
            <li> <a href="{{ URL::to('/lending/iso-certification') }}" target="_blank"> ISO Certification </a></li>
            <li> <a href="{{ URL::to('/lending/e-filing') }}" target="_blank"> E-Filing </a></li>
		</ul>
      <ul class="list-unstyled box">
        <li class="link_name">Buyer</li>
	    <li><a href="#" data-target="#postBuyerReqModal" data-toggle="modal">Post by Requirement </a></li>
		<li> <a href="{{ URL::to('/best-sellers') }}"> Search Supplier</a></li>
        <li> <a href="#" data-target="#rqstcall" data-toggle="modal"> Request Callback </a></li>
	 </ul>
      <ul class="list-unstyled box">
          <li class="link_name">Supplier</li>
		<li> <a href="{{ URL::to('/search-leads') }}"> Search Buy Leads</a></li>
        <li> <a href="{{ URL::to('/freights') }}"> Get Frieght Quotes </a></li>
        <li> <a href="{{ URL::to('/logistics') }}" target="_blank"> Logistics </a></li>
        <li> <a href="{{ URL::to('/logistics/export') }}" target="_blank"> Export Bill Discounting </a></li>
	  </ul>
		...
		<section class="footer-top padding-top">
			<div class="row">
				...
				<aside class="col-sm-4 col-md-2 col-lg-2 white">
					...
					<ul class="list-unstyled">
					    <li><a href="{{ URL::to('/best-sellers') }}">Manufacturer </a></li>
						<li> <a href="{{ URL::to('/services-provide') }}"> Service Provider</a></li>
                        <li> <a href="{{ URL::to('/locations') }}"> Find Supplier by Region  </a></li>
                        <li> <a href="{{ URL::to('/services-provide') }}"> Business Service </a></li>
                        <li> <a  href="{{ URL::to('/search-leads') }}"> Buy Trade Leads </a></li>
					</ul>
				</aside>
			</div> 
			<br> 
   ...
   <div class="container pt-4">
      <div class="row">
			<div class="col-lg-6 col-md-6 col-sm-12"> 
				<p class="text-white">@php echo $allsettings->site_copyright; @endphp</p>
			</div>
					...
					<!--<ul>
					        ...
					        <li>
                                <a href="{{ $allsettings->facebook_url }}" target="_blank">
                                    <a href="https://youtu.be/Nz5fcL0oEGY" target="_blank"><img src="{{ url('/') }}/public/img/new-img/youtube.png" alt="facebook"></a>
                                </a>
                            </li>
                            <li>
                                <a href="{{ $allsettings->facebook_url }}" target="_blank">
                                    <a href="https://twitter.com/BusinessWorldT2" target="_blank"><img src="{{ url('/') }}/public/img/new-img/twitter.png" alt="facebook"></a>
                                </a>
                            </li>
					        <li>
                                <a href="{{ $allsettings->facebook_url }}" target="_blank">
                                    <a href="https://in.pinterest.com/BusinessWorldTrade/" target="_blank"><img src="{{ url('/') }}/public/img/new-img/pinterest.png" alt="facebook"></a>
                                </a>
                            </li>
...
<div class="rstcall">
<button class="callbck" data-target="#rqstcall" data-toggle="modal"><img src="{{ url('/') }}/public/img/lead-phone.png" alt="Call Back" title="CallBack Request"></button>
</div>
            	...
            	<div class="row">
            		<div class="col-md-12 con-bg1">
            			<div class="contact-form">
            				...
            				<form action="{{ url('request-callback') }}" method="POST" id="requestCallbackForm">
            					@csrf
            	...
            	<div class="row">
            		<div class="col-md-12 con-bg1">
            			<div class="contact-form">
            				...
            				<form action="{{ url('request-feedback') }}" method="POST" id="feedbackform">
            				    @csrf
            					<div class="form-group row">
            	...
            	<div class="row">
            		<div class="col-md-12 con-bg1">
            			<div class="contact-form">
            				...
            				<form action="{{url('e-filing/detail/add') }}" method="POST" id="e-FilingForm" enctype="multipart/form-data">
            				    @csrf 
            				    <div class="row">
            					<div class="form-group col-sm-6">
            					    <div class="">
