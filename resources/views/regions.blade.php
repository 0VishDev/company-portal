...
<head>
  <title>Supplier By State - {{ $allsettings->site_title }}</title>
  @include('style')
</head>
  ...
  <main role="main" class="main-content">
	...
	<section class="headerbg" style="background-image: url('{{ url('/') }}/public/storage/settings/{{ $allsettings->site_header_background }}');">
      <div class="container text-left">
        ...
        <p class="mb-0"><a href="/">Home</a> <span class="split">&gt;</span> <span>{{ $state->state_name }}</span></p>
      </div>
    </section>
...
<div class="row">
	<div class="col-sm-12">
	<h4 class="black mb-3 pb-3 mt-4 pt-4">Industrial & Manufacturing Hubs In {{ $state->state_name }}
	</h4>
	</div>
</div>
	...
	<div class="col-sm-6 col-md-4 col-lg-3 mb-3">
      <a href="{{ url('/') }}/city/{{ \ZigKart\Helpers::joinString($city->city_name) }}">
        <div class="rigion-name"><i class="fa fa-map-marker" aria-hidden="true"></i> {{ $city->city_name  }}</div>
      </a>
		</div>
		 @endforeach
	</div>
