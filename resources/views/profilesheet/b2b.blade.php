...
<html lang="en">
  ...
  <head>
    ...
    <link rel="stylesheet" href="{{ url('/') }}/resources/views/template/mettersheets/font-awesome-4.7.0/css/font-awesome.min.css">
      <link href="{{ url('/') }}/resources/views/template/mettersheets/css/bootstrap.min.css" rel="stylesheet" id="bootstrap-css">
    <link rel="stylesheet" type="text/css" href="{{ url('/') }}/resources/views/template/mettersheets/css/style.css">
...
@endif
    ...
    <div class="container register">
    	...
    	@endif
                    ...
                    <div class="col-md-12">
                        <form action="{{ url('b2b-profile/detail/add') }}" method="POST" enctype="multipart/form-data" id="b2bProfileForm">
                            @csrf
    ...
    <script src="{{ url('/') }}/resources/views/template/mettersheets/js/bootstrap.min.js"></script>
    <script src="{{ url('/') }}/resources/views/template/mettersheets/js/jquery.min.js"></script>
    <script src="https://code.jquery.com/jquery-3.5.1.min.js"></script>
    <script src="{{ url('/') }}/resources/views/template/mettersheets/js/custom.js"></script> 
