@include('vendor-themes.theme-3.includes.header')
			...
			<div class="row">
				...
				<div class="col-md-8">
					...
					<p class="add-gst">
						...
						<span><img src="{{ asset('resources/views/template/vendor-themes/theme-3/images/trast.png') }}" alt="trust">
                            ...
                            <div class="product-item bg-light">
                            	<div class="card text-center">
                            		...
                            		<div class="card-body p-4">
                            		    ...
                            		    <p class="card-text"><button class="btn btn-theme3 btn-sm" title="{{ $product->product_name }}" data-send-inquiry-btn seller="{{ $product->user }}" buyer="@if(Auth::check()) {{ Auth::user() }} @endif" product="{{ $product }}">Send Inquiry</button></p>
                            		</div>
                            	</div>
                            </div>
    					</li>
            	     ...
            	     @foreach($user_details->package_tags as $packageTag)
                    	<div class="col-sm-12 col-md-6 col-lg-3 mb-3">
                    	    <div class="shadow vendor">
                    		    ...
                    		    <span>Services Package<br><span class="pack-abo">{{ $packageTag->service_provider->provider_name }}</span></span>
                    		</div>
                    	</div>
                    @endforeach
                  @endif
					...
					<div class="col-sm-12 col-md-6 col-lg-3 mb-3">
						<div class="shadow vendor">
							...
							<span>Nature of Business<br><span class="pack-abo">{{ $user_details->nature_of_business }}</span></span>
						</div>
					</div>
					<div class="col-sm-12 col-md-6 col-lg-3 mb-3">
						<div class="shadow vendor">
							...
							<span>Total Number of Employees<br><span class="pack-abo">{{ $user_details->no_of_employees }}</span></span>
						</div>
					</div>
					<div class="col-sm-12 col-md-6 col-lg-3 mb-3">
						<div class="shadow vendor">
							...
							<span>Year of Establishment<br><span class="pack-abo">{{ $user_details->year_of_establishment }}</span></span>
						</div>
					</div>
					<div class="col-sm-12 col-md-6 col-lg-3 mb-3">
						<div class="shadow vendor">
							...
							<span>Legal Status of Firm<br><span class="pack-abo">{{ $user_details->legal_status_of_firm }}</span></span>
						</div>
					</div>
					<div class="col-sm-12 col-md-6 col-lg-3 mb-3">
						<div class="shadow vendor">
							...
							<span>Annual Turnover<br><span class="pack-abo">{{ $user_details->annual_turnover }}</span></span>
						</div>
					</div>
					<div class="col-sm-12 col-md-6 col-lg-3 mb-3">
						<div class="shadow vendor">
							...
							<span>GST Number<br><span class="pack-abo">{{ $user_details->gst_no }}</span></span>
						</div>
					</div>
					...
					<div class="row mt-30">
						...
						<div class="col-sm-12 col-lg-3 col-md-6 mb-3" style="{{ ($key > 7 ? 'display:none;' : '') }}" {{ ($key > 7 ? 'data-product-list' : '') }}>
							...
							<div class="product-item shadow">
								<div class="card">
									...
									<div class="card-body">
										<h4 class="card-title1"><a href="{{ URL::to('/product') }}/{{ $product->product_slug }}" title="{{ $product->product_name }}">{{ $product->product_name }}</a></h4>
						...
						@if(count($shop['product']) > 8)
    						<div class="col-sm-12 col-md-12 text-center">
    						    ...
    						    <button type="button" class="btn btn-sm btn-theme3" id="product_show_more_btn">Show More</button>
    						    <button type="button" class="btn btn-sm btn-theme3" id="product_show_less_btn" style="display: none;">Show Less</button>
    						</div>
    					@endif
					</div>
				</div>
...
@include('vendor-themes.theme-3.includes.footer')