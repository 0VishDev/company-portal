@include('vendor-themes.theme-2.includes.header')


{{--<section class="mt-5">
	<div class="container">
		<div class="search-result bg-blue">
			<div class="row">
				<div class="col-md-2">
				...
				<div class="col-md-8">
					...
					<p class="add-gst">
						<span><svg xmlns="http://www.w3.org/2000/svg" width="20" height="18" viewBox="0 0 18 18">
							...
							</svg> {{ $user_details->user_address }}
						</span>
						@if(!is_null($user_details->certification) and $user_details->certification != '')
						<span><img src="{{ asset('resources/views/template/vendor-themes/theme-2/images/trast.png') }}" alt="vr trust">
							TrustSEAL Verified</span>
						@endif
					</p>
				</div>
			</div>
                            ...
                            <div class="product-item bg-light">
                            	<div class="card text-center">
                            		...
                            		<div class="card-body">
                            		    ...
                            		    <p class="card-text"><button class="btn btn-theme2 btn-sm" title="{{ $product->product_name }}" data-send-inquiry-btn seller="{{ $product->user }}" buyer="@if(Auth::check()) {{ Auth::user() }} @endif" product="{{ $product }}">Send Inquiry</button></p>
                            		</div>
                            	</div>
                            </div>
    					</li>
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-lg-12 col-md-12 mb-3">
				<div class="row">
					@foreach($shop['product'] as $key => $product)
					<div class="col-lg-4 col-md-6 mb-3" style="{{ ($key > 8 ? 'display:none;' : '') }}" {{ ($key > 8 ? 'data-product-list' : '') }}>
						<!-- ad listing list  -->
							...
							<div class="row pt-3 pl-2">
								<div class="col-lg-5 align-self-center mb-3">
									...
									@if($product->product_image != "")
                                        <img class="card-img-top" src="{{ url('/') }}/public/storage/product/{{ $product->product_image }}" alt="{{ $product->product_name }}">
                                    @else
                                        <img class="card-img-top" src="{{ url('/') }}/public/img/no-image.jpg" alt="{{ $product->product_name }}">
                                    @endif
                                    </a>
								</div>
								<div class="col-lg-7">
									<div class="row">
										<div class="col-lg-12 col-md-12 mb-3">
											<div class="ad-listing-content">
												<div>
													<h4><a href="{{ URL::to('/product') }}/{{ $product->product_slug }}" title="{{ $product->product_name }}" class="font-weight-bold">{{ $product->product_name }}</a></h4>
												</div>
...
<section class="pt-5" id="about_us">
	<div class="container">
            	...
            	<div class="col-sm-12 col-md-6 col-lg-3 mb-3">
            	    <div class="shadow vendor">
            		    <span>
                           ...
                           @else 
                              <img src="{{ url('/') }}/public/img/no-image.jpg" alt="{{ $packageTag->service_provider->provider_name }}"  alt="{{ $packageTag->service_provider->provider_name }}"/>  
                           @endif
            			</span>
            		    <span>Services Package<br><span class="ven-abo">{{ $packageTag->service_provider->provider_name }}</span></span>
            		</div>
            	</div>
            @endforeach
          @endif
			<div class="col-sm-12 col-md-6 col-lg-3 mb-3">
				<div class="shadow vendor">
					...
					<span>Nature of Business<br><span class="ven-abo">{{ $user_details->nature_of_business }}</span></span>
				</div>
			</div>
			<div class="col-sm-12 col-md-6 col-lg-3 mb-3">
				<div class="shadow vendor">
					...
					<span>Total Number of Employees<br><span class="ven-abo">{{ $user_details->no_of_employees }}</span></span>
				</div>
			</div>
			<div class="col-sm-12 col-md-6 col-lg-3 mb-3">
				<div class="shadow vendor">
					...
					<span>Year of Establishment<br><span class="ven-abo">{{ $user_details->year_of_establishment }}</span></span>
				</div>
			</div>
			<div class="col-sm-12 col-md-6 col-lg-3 mb-3">
				<div class="shadow vendor">
					...
					<span>Legal Status of Firm<br><span class="ven-abo">{{ $user_details->legal_status_of_firm }}</span></span>
				</div>
			</div>
			<div class="col-sm-12 col-md-6 col-lg-3 mb-3">
				<div class="shadow vendor">
					...
					<span>Annual Turnover<br><span class="ven-abo">{{ $user_details->annual_turnover }}</span></span>
				</div>
			</div>
			<div class="col-sm-12 col-md-6 col-lg-3 mb-3">
				<div class="shadow vendor">
					...
					<span>GST Number<br><span class="ven-abo">{{ $user_details->gst_no }}</span></span>
				</div>
			</div>
			<div class="col-sm-12 col-md-6 col-lg-3 mb-3">
		<div class="shadow vendor">
		...
		<span>PAN Number<br><span class="ven-abo">{{ $user_details->pan_no }}</span></span>
		</div>
		</div>
		</div>
	</div>
...
@include('vendor-themes.theme-2.includes.footer')