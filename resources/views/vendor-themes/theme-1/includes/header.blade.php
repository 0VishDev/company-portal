...
@endif
  ...
  <!-- Font Awesome -->
  <link href="{{ asset('resources/views/template/vendor-themes/theme-1/plugins/font-awesome/css/font-awesome.min.css') }}" rel="stylesheet">
  <!-- Owl Carousel -->
  <link href="{{ asset('resources/views/template/vendor-themes/theme-1/plugins/slick-carousel/slick/slick.css') }}" rel="stylesheet">
  <link href="{{ asset('resources/views/template/vendor-themes/theme-1/plugins/slick-carousel/slick/slick-theme.css') }}" rel="stylesheet">
  <!-- Fancy Box -->
  <link href="{{ asset('resources/views/template/vendor-themes/theme-1/plugins/fancybox/jquery.fancybox.pack.css') }}" rel="stylesheet">
  <link href="{{ asset('resources/views/template/vendor-themes/theme-1/plugins/jquery-nice-select/css/nice-select.css') }}" rel="stylesheet">
  <!-- CUSTOM CSS -->
  <link href="{{ asset('resources/views/template/vendor-themes/theme-1/css/style.css') }}" rel="stylesheet">
