...
@endif
 <!-- Bootstrap -->
  <link rel="stylesheet" href="{{ asset('resources/views/template/vendor-themes/theme-1/plugins/bootstrap/css/bootstrap.min.css') }}">
  <link rel="stylesheet" href="{{ asset('resources/views/template/vendor-themes/theme-1/plugins/bootstrap/css/bootstrap-slider.css') }}">
  <!-- Font Awesome -->
  <link href="{{ asset('resources/views/template/vendor-themes/theme-4/plugins/font-awesome/css/font-awesome.min.css') }}" rel="stylesheet">
  <!-- Owl Carousel -->
  <link href="{{ asset('resources/views/template/vendor-themes/theme-4/plugins/slick-carousel/slick/slick.css') }}" rel="stylesheet">
  <link href="{{ asset('resources/views/template/vendor-themes/theme-4/plugins/slick-carousel/slick/slick-theme.css') }}" rel="stylesheet">
  <!-- Fancy Box -->
  <link href="{{ asset('resources/views/template/vendor-themes/theme-4/plugins/plugins/fancybox/jquery.fancybox.pack.css') }}" rel="stylesheet">
  <link href="{{ asset('resources/views/template/vendor-themes/theme-4/plugins/jquery-nice-select/css/nice-select.css') }}" rel="stylesheet">
  <!-- CUSTOM CSS -->
  <link href="{{ asset('resources/views/template/vendor-themes/theme-4/css/style.css') }}" rel="stylesheet">
