@include('vendor-themes.theme-4.includes.header')
			...
			<div class="row">
				...
				<div class="col-md-8">
					...
					<p class="add-gst">
						...
						<span><img src="{{ asset('resources/views/template/vendor-themes/theme-3/images/trast.png') }}" alt="vr trust">
    					...
    					<li>
                            ...
                            <div class="product-item bg-light">
                            	<div class="card text-center">
                            		...
                            		<div class="card-body">
                            		    <h4 class="card-title"><a href="{{ URL::to('/product') }}/{{ $product->product_slug }}">{{ $product->product_name }}</a></h4>
                            		    <p class="card-text"><button class="btn btn-theme4 btn-sm" data-send-inquiry-btn seller="{{ $product->user }}" buyer="@if(Auth::check()) {{ Auth::user() }} @endif" product="{{ $product }}">Send Inquiry</button></p>
                            		</div>
                            	</div>
                            </div>
    					</li>
									...
									<div class="row">
										<div class="col-lg-12 col-md-12 mb-3">
											<div class="ad-listing-content">
												<div>
													<h4><a href="{{ URL::to('/product') }}/{{ $product->product_slug }}" class="font-weight-bold" title="{{ $product->product_name }}">{{ $product->product_name }}</a></h4>
												</div>
...
@include('vendor-themes.theme-4.includes.footer')