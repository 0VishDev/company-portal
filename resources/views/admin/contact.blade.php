                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <table class="table table-striped table-bordered table-responsive" id="sellerContactTable">
                                    ...
                                    <tbody>
                                        @php $no = 0; @endphp
                                        @foreach($contactInquiry as $inquiry)
                                            <tr>
                                            <td>{{ ++$no }}</td>
                                                ...
                                                <td>
                                                    ...
                                                    @if($inquiry->is_verify == 0)
                                                        <a href="{{ url('admin/contact/'.$inquiry->id.'/verify') }}" class="btn btn-danger mb-1" title="Verify"><span class="fa fa-stop-circle-o"></span></a>
                                                    @endif
                                                    <a href="{{ url('admin/contact/'.$inquiry->id.'/delete') }}" title="Delete" class="btn btn-danger mb-1" onClick="return confirm('Are you sure you want to delete?');"><span class="fa fa-trash"></span></a>
                                                </td>
                                            </tr> 
                                        @endforeach
                                    </tbody>
      ...
      <div class="modal-dialog modal-sm modal-dialog-centered " role="document">
        <div class="modal-content">
          <div class="modal-header">
           ...
           <form action="{{ url('admin/contact/comment/add') }}" method="POST" enctype="multipart/form-data">
               @csrf
