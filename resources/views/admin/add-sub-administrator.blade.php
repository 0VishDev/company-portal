            ...
            <div class="animated fadeIn">
                ...
                <div class="col-md-12">
                    <div class="card">
                           ...
                           @else
                           <form action="{{ url('/admin/sub-administrator/add') }}" method="post" id="setting_form" enctype="multipart/form-data">
                           {{ csrf_field() }}
                           @endif
                           <div class="col-md-6">
                           <div class="card-body">
                           ...
                           <div class="card-body">
                            ...
                            <div class="form-group">
                                    ...
                                    @foreach($permission['admin'] as $key => $value)
                                     <li class=row>
                                     <span class="col-sm-6 mb-1"><input type="checkbox" id="user_permission[]" name="user_permission[]" value="{{ $key }}"> {{ $value }}</span>
