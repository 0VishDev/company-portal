                                ...
                                <table  class="table table-striped table-bordered table-responsive" id="exportTable">
                                    ...
                                    @foreach($serviceProviders as $serviceProvider)
                                        <tr>
                                            ...
                                            <td>
                                                {{ $serviceProvider->iec_no }}
                                            </td>
                                            <td>
                                                {{ $serviceProvider->product_export }}
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                ...
                                                <a href="{{ url('admin/export-data-delete/'.$serviceProvider->id.'/delete') }}" class="btn btn-danger mb-1" onClick="return confirm('Are you sure you want to delete?');"><i class="fa fa-trash"></i></a>
                                            </td>
      ...
      <div class="modal-dialog modal-sm modal-dialog-centered " role="document">
        <div class="modal-content">
          <div class="modal-header">
           ...
           <form action="{{ url('admin/export-billing/comment/add') }}" method="POST" enctype="multipart/form-data">
               @csrf
