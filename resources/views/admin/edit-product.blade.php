                                    ...
                                    <div class="card-body">
                                       <div class="form-group">
                                            ...
                                            <div class="form-group">
                                               ...
                                               <textarea name="product_short_desc" id="product_short_desc" rows="4" class="form-control noscroll_textarea" data-bvalidator="required,maxlen[960]">{{ $edit['product']->product_short_desc }}</textarea>
                                            </div> 
                                            <div class="form-group">
                                    ...
                                    <div class="card-body">
                                      <div class="form-group">
                                         ...
                                         <div class="form-group">
                                          ...
                                          <div id="ifphysical_external" @if($edit['product']->product_type == 'physical' or $edit['product']->product_type == 'external') class="form-group force-block" @else class="form-group force-none" @endif>
                                            {{-- <div class="form-group">
                                     ...
                                     {{-- <div class="form-group">
                                         ...
                                         {{--<div id="ifdigitals" @if($edit['product']->product_type == 'digital') class="form-group force-block" @else class="form-group force-none" @endif>
                                             ...
                                             <div id="ifexternals" @if($edit['product']->product_type == 'external') class="form-group force-block" @else class="form-group force-none" @endif>
                                                 {{-- <label for="name" class="control-label mb-1">External Url <span class="require">*</span></label>
                                                <input id="product_external_url" name="product_external_url" type="text" class="form-control" data-bvalidator="url" value="{{ $edit['product']->product_external_url }}"></div><div id="ifphysical" @if($edit['product']->product_type == 'physical') class="form-group force-block" @else class="form-group force-none" @endif> --}}
                                     {{-- <div class="form-group">
