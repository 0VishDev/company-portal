                ...
                <div class="row">
                  <div class="col-md-12">
                      @if($demo_mode == 'on')
                           ...
                           @else
                       <form action="{{ route('admin.edit-subcategory') }}" method="post" enctype="multipart/form-data">
                       {{ csrf_field() }}
                        @endif
                        <div class="card">
                          <div class="col-md-6">
                                    ...
                                    <div class="card-body">
                                       <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="hidden" name="save_subcategory_image" value="{{ $edit['subcategory']->subcategory_image }}">
                                            </div>
                                            <!--<div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input id="seo_title" name="seo_title" type="text" class="form-control" value="{{ $edit['subcategory']->seo_title }}">
                                            </div>
                                            <div class="form-group">
                                                <label for="site_title" class="control-label mb-1"> SEO Keywords</label>
                                                <textarea name="seo_keywords" id="seo_keywords" class="form-control">{{ $edit['subcategory']->seo_keywords }}</textarea>
                                            </div>
                                            
                                            <div class="form-group">
                                                <label for="site_title" class="control-label mb-1"> SEO Meta Description</label>
                                                <textarea name="seo_meta_description" id="seo_meta_description" class="form-control">{{ $edit['subcategory']->seo_meta_description }}</textarea>
                                            </div>
