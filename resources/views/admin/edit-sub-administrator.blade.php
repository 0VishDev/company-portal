         ...
         <div class="content mt-3">
            <div class="animated fadeIn">
                <div class="row">
                   <div class="col-md-12">
                      <div class="card">
                           <form action="{{ url('/admin/sub-administrator/'.$edit['userdata']->id.'/update') }}" method="post" id="setting_form" enctype="multipart/form-data">
                           {{ csrf_field() }}
                                              ...
                                              <input type="hidden" name="user_type" value="sub-admin">
                                               <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                                    ...
                                                                    <input type="file" id="user_photo" name="user_photo" class="form-control-file" data-bvalidator="extension[jpg:png:jpeg]" data-bvalidator-msg="Please select file of type .jpg, .png or .jpeg">@if($edit['userdata']->user_photo != '')
                                ...
                                <div id="pay-invoice">
                                  ...
                                  <div class="form-group">
                                    ...
                                    @foreach($permission['admin'] as $key => $value)
                                     <li class=row>
                                     <span class="col-sm-6 mb-1"><input type="checkbox" id="user_permission[]" name="user_permission[]" value="{{ $key }}" @if(in_array($key,$edituser)) checked @endif> {{ $value }}</span><br/>
