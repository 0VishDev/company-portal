                                       ...
                                       <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                <label for="site_keywords" class="control-label mb-1">Short Description <span class="require">*</span></label>
                                                 <textarea name="product_short_desc" id="product_short_desc" rows="4" class="form-control noscroll_textarea" data-bvalidator="required,maxlen[860]"></textarea>
                                            </div> 
                                            <div class="form-group">
                           ...
                           <div class="col-md-6">
                             <div class="card-body">
                                ...
                                <div id="pay-invoice">
                                  ...
                                  <div id="ifphysical_external">
                                     ...
                                     {{--<div class="form-group" id="ifdigitals">
                            ...
                            {{--<div id="ifphysical">
                                    ...
                                    <div class="form-group">
                                                ...
                                                <input type="file" id="product_image" name="product_image" class="form-control-file" data-bvalidator="required,extension[jpg:png:jpeg]" data-bvalidator-msg="Please select file of type .jpg, .png or .jpeg">
                                                </div> 
