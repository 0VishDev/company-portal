                                    ...
                                    <div class="card-body">
                                         <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <option value=""></option>
                                                <option value="image" @if($edit['post']->post_media_type == 'image') selected @endif>Image</option>
                                                <option value="video" @if($edit['post']->post_media_type == 'video') selected @endif>Video</option>
                                                </select>
                                            </div>
                                            ...
                                            <input type="file" id="post_image" name="post_image" class="form-control-file" @if($edit['post']->post_image == '') data-bvalidator="required,extension[jpg:png:jpeg]" data-bvalidator-msg="Please select file of type .jpg, .png or .jpeg" @else data-bvalidator="extension[jpg:png:jpeg]" data-bvalidator-msg="Please select file of type .jpg, .png or .jpeg" @endif>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <option value=""></option>
                                                <option value="1" @if($edit['post']->post_status == 1) selected="selected" @endif>Active</option>
                                                <option value="0" @if($edit['post']->post_status == 0) selected="selected" @endif>InActive</option>
                                                </select>
                                            </div>   
