...
<head>
  <title>{{ ($subCategory->subcategory_name) }} - {{ $allsettings->site_title }}</title>
  @include('style')
</head>
  ...
  <main role="main" class="main-content">
	...
	<section class="headerbg" style="background-image: url('{{ url('/') }}/public/storage/settings/{{ $allsettings->site_header_background }}');">
      <div class="container text-left">
        ...
        <p class="mb-0"><a href="/">Home</a> <span class="split">&gt;</span> <span>{{ ($subCategory->subcategory_name) }}</span></p>
      </div>
    </section>
    ...
    <div class="container mt-3 bg-white shadow sub-pro">
		...
		<div class="col-sm-12 col-md-12">
			...
			<p>EXPLORE MORE PRODUCTS IN {{ strtoupper($subCategory->subcategory_name) }}</p>
			</div>
			</div>
		</div>
		<hr>
                                ...
                                <div class="col-lg-2 col-md-4 col-sm-4 col-xs-6 mb-2 pb-2 list-item">
                                    <div class="product-grid2">
                                        ...
                                        <div class="product-content sub-cate-page">
                                            <h3 class="title"><a href="{{ url('shop?product='.$product['product_slug']) }}">{{ $product['product_name'] }}</a></h3>
                                        </div>
                                    </div>
                                </div>
                            @endforeach
