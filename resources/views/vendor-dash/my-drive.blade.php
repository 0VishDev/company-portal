          ...
          <div class="col-md-12">
            <div id="tabsJustifiedContent" class="tab-content pro">
              <div id="pdf" class="tab-pane fade active show">
                <div class="row">
                  <div class="col-sm-12 col-md-12 col-lg-12 mt-4">
                    <h5><a href="#">All files ({{ (isset($productDocs['PDF']) ? count($productDocs['PDF']) : '0') }})</a> &gt; Pdf Files</h5>
                  </div>
                  @if(isset($productDocs['PDF']))
                    @foreach($productDocs['PDF'] as $productDoc)
                        <div class="col-sm-6 col-md-4 col-lg-4 mt-4">
                            <div class="card shadow">
                              ...
                              <div class="card-block">
                                <h4 class="card-title"><i class="fa fa-file-pdf-o" aria-hidden="true"></i> {{ $productDoc->file_name }}</h4>
                              </div>
                              <div class="card-footer">
                                <span class="">Uploaded: {{ \Carbon\Carbon::parse($productDoc->created_at)->format('d M, Y') }}</span>
                                ...
                                <span>
                                  <div class="user-area dropdown float-right">
                                    ...
                                    <div class="user-menu dropdown-menu">
                                      <a class="nav-link" href="{{ url('vendor/product-docs/update') }}" data-product-docs-edit-btn docs-id="{{ $productDoc->id }}" file-name="{{ $productDoc->file_name }}"><i class="fa fa-pencil" aria-hidden="true"></i> Rename</a>                            
                                      <a class="nav-link" href="{{ asset('public/storage/product-docs/'. $productDoc->upload_file_name) }}" target="_blank"><i class="fa fa-download" aria-hidden="true"></i> Download</a>
                                      <a class="nav-link" href="{{ url('vendor/product-docs/'.$productDoc->id.'/delete') }}" onclick="return confirm('Are you sure you want to delete this file?');"><i class="fa fa-trash" aria-hidden="true"></i> Delete</a>
                                    </div>
                                  </div>
                                </span>
                              </div>
                  ...
                  <div class="col-sm-12 col-md-12 text-center">
                    <form action="{{ url('vendor/product-docs/add') }}" enctype="multipart/form-data" id="pdfForm" method="POST">
                        @csrf
              ...
              <div id="excel" class="tab-pane fade">
                <div class="row">
                  <div class="col-sm-12 col-md-12 col-lg-12 mt-4">
                    <h5><a href="#">All files ({{ (isset($productDocs['EXCEL']) ? count($productDocs['EXCEL']) : '0') }})</a> &gt; Excel Files</h5>
                  </div>
                  <div class="col-sm-12 col-md-12">
                    @if(isset($productDocs['EXCEL']))
                        @foreach($productDocs['EXCEL'] as $productDoc)
                            <div class="col-sm-6 col-md-4 col-lg-4 mt-4">
                                <div class="card shadow">
                                  <div class="card-img">
                                  ...
                                  <div class="card-block">
                                    <h4 class="card-title"><i class="fa fa-file-excel-o" aria-hidden="true"></i> {{ $productDoc->file_name }}</h4>
                                  </div>
                                  <div class="card-footer">
                                    <span class="">Uploaded: {{ \Carbon\Carbon::parse($productDoc->created_at)->format('d M, Y') }}</span>
                                    <!--<span><a href="#" class="save-pro">Save as Product</a></span>-->
                  ...
                  @endif
                  <div class="col-sm-12 col-md-12 text-center">
                    <form action="{{ url('vendor/product-docs/add') }}" enctype="multipart/form-data" id="excelForm" method="POST">  
                        @csrf
              ...
              <div id="word" class="tab-pane fade">
                <div class="row">
                  <div class="col-sm-12 col-md-12 col-lg-12 mt-4">
                    <h5><a href="#">All files ({{ (isset($productDocs['WORD']) ? count($productDocs['WORD']) : '0') }})</a> &gt; Word Docs</h5>
                  </div>
                  <div class="col-sm-12 col-md-12">
                    @if(isset($productDocs['WORD']))
                        @foreach($productDocs['WORD'] as $productDoc)
                            <div class="col-sm-6 col-md-4 col-lg-4 mt-4">
                                <div class="card shadow">
                                  <div class="card-img">
                                  ...
                                  <div class="card-block">
                                    <h4 class="card-title"><i class="fa fa-file-word-o" aria-hidden="true"></i> {{ $productDoc->file_name }}</h4>
                                  </div>
                                  <div class="card-footer">
                                    <span class="">Uploaded: {{ \Carbon\Carbon::parse($productDoc->created_at)->format('d M, Y') }}</span>
                                    <!--<span><a href="#" class="save-pro">Save as Product</a></span>-->
                      ...
                      @endif
                      <div class="col-sm-12 col-md-12 text-center">
                      <form action="{{ url('vendor/product-docs/add') }}" enctype="multipart/form-data" id="wordForm" method="POST">
                         @csrf
              ...
              <div id="zip" class="tab-pane fade">
                <div class="row">
                  <div class="col-sm-12 col-md-12 col-lg-12 mt-4">
                    <h5><a href="#">All files ({{ (isset($productDocs['ZIP']) ? count($productDocs['ZIP']) : '0') }})</a> &gt; Zip Files</h5>
                  </div>
                  <div class="col-sm-12 col-md-12">
                    @if(isset($productDocs['ZIP']))
                        @foreach($productDocs['ZIP'] as $productDoc)
                            <div class="col-sm-6 col-md-4 col-lg-4 mt-4">
                                <div class="card shadow">
                                  <div class="card-img">
                                  ...
                                  <div class="card-block">
                                    <h4 class="card-title"><i class="fa fa-file-archive-o" aria-hidden="true"></i> {{ $productDoc->file_name }}</h4>
                                  </div>
                                  <div class="card-footer">
                                    <span class="">Uploaded: {{ \Carbon\Carbon::parse($productDoc->created_at)->format('d M, Y') }}</span>
                                    <!--<span><a href="#" class="save-pro">Save as Product</a></span>-->
                    ...
                    @endif
                    <div class="col-sm-12 col-md-12 text-center">
                    <form action="{{ url('vendor/product-docs/add') }}" enctype="multipart/form-data" id="zipForm" method="POST">
                        @csrf
          ...
          <div class="modal fade" id="editFileNameModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  ...
                  <form action="{{ url('vendor/product-docs/update') }}" method="POST">
                      @csrf
