...
<script src="{{ url('/') }}/resources/views/admin/template/vendors/jquery/dist/jquery.min.js"></script>
<script src="{{ url('/') }}/resources/views/admin/template/vendors/popper.js/dist/umd/popper.min.js"></script>
<script src="{{ url('/') }}/resources/views/admin/template/assets/js/main.js"></script>
<script src="{{ url('/') }}/resources/views/admin/template/assets/js/jquery.min.js"></script>
<!--<script src="{{ url('/') }}/resources/views/admin/template/vendors/chart.js/dist/Chart.bundle.min.js"></script>-->
<!--<script src="{{ url('/') }}/resources/views/admin/template/assets/js/dashboard.js"></script>-->
<!--<script src="{{ url('/') }}/resources/views/admin/template/assets/js/widgets.js"></script>-->
<script src="{{ url('/') }}/resources/views/admin/template/vendors/jqvmap/dist/jquery.vmap.min.js"></script>
<script src="{{ url('/') }}/resources/views/admin/template/vendors/jqvmap/examples/js/jquery.vmap.sampledata.js"></script>
<script src="{{ url('/') }}/resources/views/admin/template/vendors/jqvmap/dist/maps/jquery.vmap.world.js"></script>
<script src="{{ url('/') }}/resources/views/admin/template/vendors/bootstrap/dist/js/bootstrap.min.js"></script>
<script>
    // (function($) {
    //     "use strict";
...
<script src="{{ url('/') }}/resources/views/admin/template/vendors/datatables.net/js/jquery.dataTables.min.js"></script>
<script src="{{ url('/') }}/resources/views/admin/template/vendors/datatables.net-bs4/js/dataTables.bootstrap4.min.js"></script>
<script src="{{ url('/') }}/resources/views/admin/template/vendors/datatables.net-buttons/js/dataTables.buttons.min.js"></script>
<script src="{{ url('/') }}/resources/views/admin/template/vendors/datatables.net-buttons-bs4/js/buttons.bootstrap4.min.js"></script>
<script src="{{ url('/') }}/resources/views/admin/template/vendors/jszip/dist/jszip.min.js"></script>
<script src="{{ url('/') }}/resources/views/admin/template/vendors/pdfmake/build/pdfmake.min.js"></script>
<script src="{{ url('/') }}/resources/views/admin/template/vendors/pdfmake/build/vfs_fonts.js"></script>
<script src="{{ url('/') }}/resources/views/admin/template/vendors/datatables.net-buttons/js/buttons.html5.min.js"></script>
<script src="{{ url('/') }}/resources/views/admin/template/vendors/datatables.net-buttons/js/buttons.print.min.js"></script>
<script src="{{ url('/') }}/resources/views/admin/template/vendors/datatables.net-buttons/js/buttons.colVis.min.js"></script>
<script src="{{ url('/') }}/resources/views/admin/template/assets/js/init-scripts/data-table/datatables-init.js"></script>
<script src="{{ url('/') }}/vendor/unisharp/laravel-ckeditor/ckeditor.js"></script>
<script src="{{ url('/') }}/resources/views/template/validate/jquery.bvalidator.min.js"></script>
<script src="{{ url('/') }}/resources/views/template/validate/themes/presenters/default.min.js"></script>
<script src="{{ url('/') }}/resources/views/template/validate/themes/red/red.js"></script>
<link href="{{ url('/') }}/resources/views/template/validate/themes/red/red.css" rel="stylesheet" />
<script src="{{ url('/') }}/resources/views/admin/template/picker/jquery-ui.min.js"></script>
<script src="{{ url('/') }}/resources/views/admin/template/picker/jquery-ui-timepicker-addon.js"></script>
