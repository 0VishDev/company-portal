...
<div class="modal fade" id="sendInquiryModal" aria-modal="true">
    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <form action="{{ url('request/add') }}" method="POST" id="sendInquiryForm">
            @csrf
            ...
            <div class="row" >
              <div class="col-md-12 con-bg12">
                <div class="contact-info">
                    ...
                    <div class="col-md-8">
                        <img src="{{ asset('public/img/new-img/bands.png') }}" class="img-fluid" style="width:80%;height:auto;float:center;">
                    </div>
                    </div>
	             ...
	             <div class="row">
                		<div class="col-md-12 con-bg1">
                			<div class="contact-form">
                				...
                				<form action="{{ url('request/add') }}" method="POST" id="buyerReqForm">
                					@csrf
                					  <div class="form-group">
                						<label class="control-label col-sm-12" for="product_name">Product Name:</label>
                						<div class="col-sm-12">          
  ...
  <script type="text/javascript">
    ...
    var isAdminLogin = '{{ (\Request::is('admin/inquiries') ? 1 : 0) }}';
