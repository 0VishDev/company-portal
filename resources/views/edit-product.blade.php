    ...
    <div class="row">
        <div class="col-md-12">
             ...
             {{ csrf_field() }}
                ...
                <div class="form-group row">
                    <div class="col-sm-6">
                        <label for="site_keywords">{{ Helper::translation(1930,$translate) }} in less than 70 words<span class="required">*</span></label>
                        <textarea name="product_short_desc" id="product_short_desc" rows="12" class="form-control noscroll_textarea" data-bvalidator="required,maxlen[160]" placeholder="Short description of the product within 70 words">{{ $edit['product']->product_short_desc }}</textarea>
                    </div>
                    <div class="col-sm-6">
                         <label for="site_desc">{{ Helper::translation(1931,$translate) }}<span class="required">*</span></label>
                       <textarea name="product_desc" id="summary-ckeditor" rows="3"  class="form-control" data-bvalidator="required">{{ html_entity_decode($edit['product']->product_desc) }}</textarea>
                    </div>
                </div>
                <div class="form-group row">
                    <div class="col-sm-6">
                        <label for="site_title"> {{ Helper::translation(1932,$translate) }} <span class="required">*</span></label>
                        <select name="product_category[]" class="form-control h-150p" data-bvalidator="required" multiple>
                                                ...
                                                <option value="cat-{{$menu->cat_id}}" @if(in_array($cats,$product_categories)) selected="selected" @endif>{{ $menu->category_name }}</option>
                                                     ...
                                                     <option value="subcat-{{$sub_category->subcat_id}}" class="ml-2" @if(in_array($subcats,$product_categories)) selected="selected" @endif>- {{ $sub_category->subcategory_name }}</option>
                                                     @endforeach
                                                @endforeach 
                                                </select>
                    </div>
               ...
               <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                        <label for="customer_earnings">Upload Product Images</label>
                        <input type="file" id="product_gallery[]" name="product_gallery[]" class="form-control-file" data-bvalidator="extension[jpg:png:jpeg]" data-bvalidator-msg="{{ Helper::translation(1937,$translate) }}" multiple><br/>@foreach($editimage['view'] as $product)
                                     <div class="item-img"><img src="{{ url('/') }}/public/storage/product/{{ $product->product_image }}" alt="{{ $product->product_image }}" class="item-thumb">
                                                    <a href="{{ url('/edit-product') }}/dropimg/{{ base64_encode($product->proimg_id) }}" onClick="return confirm('{{ Helper::translation(1968,$translate) }}');" class="drop-icon"><span class="fa fa-trash-o drop-icon"></span></a>
                                                    </div>
                                                   @endforeach
               ...
               <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                        ...
                        <select name="product_attribute[]" class="form-control h-150p" multiple>
                ...
                <div class="form-group row">
                    <div class="col-sm-6">
                        ...
                        <input type="text" name="minimum_order_qty" class="form-control" value="{{ $edit['product']->minimum_order_qty }}">
                    </div>
                    <div class="col-sm-6">
                        <label for="minimum_order_unit">Minimum Order Unit (Ex. kg, g, piece, etc.)</label>
                        <input type="text" name="minimum_order_unit" class="form-control" value="{{ $edit['product']->minimum_order_unit }}">
                    </div>
                </div>
                <div class="form-group row">
                    <div class="col-sm-12">
