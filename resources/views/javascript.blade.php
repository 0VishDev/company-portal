...
<script src="{{ URL::to('resources/views/template/js/select2.min.js') }}"></script>
<script src="{{ URL::to('resources/views/template/js/ion.rangeSlider.min.js') }}"></script>
...
<script src="{{ URL::to('resources/views/template/js/scratch.js') }}"></script>
