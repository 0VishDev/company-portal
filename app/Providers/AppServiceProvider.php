...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        $registerStates = State::where('country_id','=', $country->country_id)->get();
        $registercities = City::where('state_id','=', $registerStates[0]['id'])->get();
        
        View::share('registerStates', $registerStates);
        View::share('registercities', $registercities);

		$allstate = Settings::allState();
		View::share('allstate', $allstate);

		$allcategories = Category::orderBy('display_order', 'asc')->get();
		View::share('allcategories', $allcategories);

		$allcity = Settings::allCity();
		View::share('allcity', $allcity);
...
// 		$permission = array('dashboard' => 'Dashboard', 'inquiries' => 'Inquiries', 'settings' => 'Settings', 'block-section' => 'Block Section', 'country' => 'Country', 'state' => 'State', 'city' => 'City', 'callback' => 'Callback Requests', 'leads' => 'Leads', 'manage-categories' => 'Manage Categories', 'products' => 'Products', 'blog' => 'Blog', 'pages' => 'Pages', 'slideshow' => 'Slideshow', 'contact' => 'Contact', 'newsletter' => 'Newsletter', 'languages' => 'Languages');
        $permission = array(
        	'admin' => array(
        		'dashboard' => 'Dashboard',
        		'inquiries' => 'Inquiries',
