...
class Category extends Model
{
    ...
    {
        return $this->hasMany(SubCategory::class, 'cat_id', 'cat_id')->where('drop_status', 'no');
    }
  ...
  public static function dropSubCategoryimage($cat_id)
  {
		 $image = DB::table('subcategory')->where('subcat_id', $cat_id)->first();
			$file= $image->subcategory_image;
			$filename = public_path().'/storage/subcategory/'.$file;
			File::delete($filename);
  }
  ...
  public static function getsubcategoryData()
  {
   ...
   public static function insertsubcategoryData($data){
    ...
    public static function deleteSubcategorydata($subcat_id,$data){
      $image = DB::table('subcategory')->where('subcat_id', $subcat_id)->first();
			$file= $image->subcategory_image;
			$filename = public_path().'/storage/subcategory/'.$file;
			File::delete($filename);
