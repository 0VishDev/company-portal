...
class BlogController extends Controller
{
	...
	public function view_single($slug)
	{
	  ...
	  $category_count = Blog::getgrouppostData();
	  $postSteps = Blog::getPostSteps($post_id);
	  
	  return view('single', [ 'edit' => $edit, 'slug' => $slug, 'catData' => $catData, 'blog' => $blog, 'blogPost' => $blogPost, 'post_tags' => $post_tags, 'comment' => $comment, 'count' => $count, 'category_count' => $category_count, 'postSteps' => $postSteps]);
