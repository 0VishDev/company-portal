...
class Product extends Model
{
 ...
 public static function insertbrandData($data){
	...
	public static function productData()
  {
    ...
    $value=DB::table('product')->join('users','users.id','product.user_id')->where('product.product_drop_status','=','no')->orderBy('product.product_id', 'desc')->get(); 
    return $value;
  ...
  public static function userproductData($user_token)
  {
    ...
    $value=DB::table('product')->join('users','users.id','product.user_id')->where('product.product_drop_status','=','no')->where('product.user_id','=',$user_token)->orderBy('product.product_id', 'desc')->get(); 
    return $value;
  ...
  public static function autoSearch($query)
  {
    ...
    $value=DB::table('product')->where('product_name', 'LIKE', '%'. $query. '%')->where('product_drop_status','=','no')->orderBy('product_name', 'asc')->get(); 
    return $value;
  ...
  public static function totaluserProduct($user_id)
  {
    ...
    $get=DB::table('product')->where('user_id','=',$user_id)->get(); 
    $value = $get->count(); 
    return $value;
  ...
  public static function saveWishlist($data){
	...
	public static function checkOrder($user_id,$product_token)
  {

    $get=DB::table('product_orders')->where('product_token','=', $product_token)->where('user_id','=', $user_id)->where('order_status','=', 'pending')->get();
	$value = $get->count(); 
    return $value;
   ...
   public static function updateOrder($user_id,$order_status,$product_token,$updata)
   {
    DB::table('product_orders')
   ...
   public static function viewOrder($user_id)
  {

    $value=DB::table('product_orders')->join('users','users.id','product_orders.product_user_id')->join('product','product.product_token','product_orders.product_token')->where('product_orders.user_id', '=', $user_id)->where('product_orders.order_status','=','pending')->orderBy('product_orders.ord_id', 'asc')->get();
    return $value;
  ...
  public static function cartCount($user_id)
  {
    ...
    $get=DB::table('product_orders')->where('order_status','=', 'pending')->where('user_id','=', $user_id)->get();
	$value = $get->count(); 
    return $value;
  ...
  public static function upOrders($user_id,$uporder)
  {
    DB::table('product_orders')
      ->where('user_id', $user_id)
	  ->where('order_status', 'pending')
  ...
  public static function gettotalProducts()
  {
    ...
    $get=DB::table('product')->where('product_drop_status','=','no')->orderBy('product_id', 'desc')->get();
	$value = $get->count(); 
    return $value;
  ...
  {
    $value=DB::table('product_orders')->join('users','users.id','product_orders.user_id')->join('product','product.product_token','product_orders.product_token')->where('product_orders.product_user_id','=',$user_id)->orderBy('product_orders.ord_id', 'desc')->get(); 
    return $value;
  }
  ...
  {
    $value=DB::table('product_orders')->join('users','users.id','product_orders.product_user_id')->join('product','product.product_token','product_orders.product_token')->where('product_orders.user_id','=',$user_id)->where('product_orders.purchase_token','=',$token)->orderBy('product_orders.ord_id', 'desc')->get(); 
    return $value;
  }
  ...
  {
    return $this->belongsTo('ZigKart\Models\Brands', 'product_brand', 'brand_id');
  }
  ...
  {
      return $this->hasMany('ZigKart\Models\ProductVariants', 'product_id', 'product_id');
  }
}
