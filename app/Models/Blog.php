...
class Blog extends Model
{
  ...
  public static function editsingleData($slug){
    $value = DB::table('post')->join('blog_category','blog_category.blog_cat_id','post.blog_cat_id')->where('post.post_slug', $slug)->first();
	return $value;
  }   
  ...
  public static function getPostSteps($id){
       $postSteps = DB::table('post_steps')->where('post_id','=', $id)->orderBy('id', 'desc')->get(); 
